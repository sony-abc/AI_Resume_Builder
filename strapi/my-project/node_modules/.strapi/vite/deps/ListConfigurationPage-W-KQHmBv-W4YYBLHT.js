...
// node_modules/@strapi/content-manager/dist/_chunks/ListConfigurationPage-W-KQHmBv.mjs
...
var Settings = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
    ...
    (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, children: formLayout.map(
      (row) => row.map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { s: 12, col: size, children: (0, import_jsx_runtime.jsx)(MemoizedInputRenderer, { ...field }) }, field.name))
    ) }, "bottom")
  ] });
};
  ...
  return (0, import_jsx_runtime.jsx)(Modal.Content, { children: (0, import_jsx_runtime.jsxs)(
    Form,
    {
      ...
      children: [
        ...
        ).map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { s: 12, col: size, children: (0, import_jsx_runtime.jsx)(MemoizedInputRenderer, { ...field }) }, field.name)) }) }),
          ...
          (0, import_jsx_runtime.jsxs)(Flex, { paddingLeft: 3, onClick: (e) => e.stopPropagation(), children: [
            ...
            (0, import_jsx_runtime.jsx)(
              ActionButton,
              {
                ...
                type: "button",
                children: (0, import_jsx_runtime.jsx)(ForwardRef$3V, { width: "1.2rem", height: "1.2rem" })
              }
            )
          ] })
        ]
...
//# sourceMappingURL=ListConfigurationPage-W-KQHmBv-W4YYBLHT.js.map
