...
// node_modules/@strapi/plugin-users-permissions/dist/_chunks/index-D2uZMaoO.mjs
          ...
          return (0, import_jsx_runtime.jsxs)(Form, { children: [
            (0, import_jsx_runtime.jsx)(Modal.Body, { children: (0, import_jsx_runtime.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 1, children: (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 5, children: layout.form.map((row) => {
              return row.map((input) => {
                return (0, import_jsx_runtime.jsx)(Grid.Item, { col: input.size, xs: 12, children: (0, import_jsx_runtime.jsx)(
                  Input,
                  {
                    ...input,
...
//# sourceMappingURL=index-D2uZMaoO-YTAIEN76.js.map
