...
// node_modules/@strapi/content-releases/dist/_chunks/App-CZe9wueI.mjs
...
var ReleasesGrid = ({ sectionTitle, releases = [], isError = false }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, children: releases.map(({ id, name, scheduledAt, status }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: 3, s: 6, xs: 12, children: (0, import_jsx_runtime.jsx)(LinkCard, { tag: NavLink, to: `${id}`, isExternal: false, children: (0, import_jsx_runtime.jsxs)(
    Flex,
    {
      direction: "column",
...
var TypographyMaxWidth = dt(Typography)`
  max-width: 300px;
`;
var EntryValidationText = ({ action, schema, entry, status }) => {
  const { formatMessage } = useIntl();
  ...
  if (action === "publish") {
    if (Object.keys(errors).length > 0) {
      ...
      return (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, children: [
        ...
        (0, import_jsx_runtime.jsx)(TooltipImpl, { description: validationErrorsMessages, children: (0, import_jsx_runtime.jsx)(
          TypographyMaxWidth,
          {
            textColor: "danger600",
            variant: "omega",
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, children: [
    (0, import_jsx_runtime.jsx)(ForwardRef$4n, { fill: "success600" }),
    !entry.publishedAt ? (0, import_jsx_runtime.jsx)(Typography, { textColor: "success600", fontWeight: "bold", children: formatMessage({
...
var ReleaseDetailsBody = ({ releaseId }) => {
  ...
  const components = (releaseMeta == null ? void 0 : releaseMeta.components) || {};
...
//# sourceMappingURL=App-CZe9wueI-NB26XDQR.js.map
