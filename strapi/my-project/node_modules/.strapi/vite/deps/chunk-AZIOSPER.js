    ...
    function baseSet(object2, path, value, customizer) {
      ...
      while (nested != null && ++index < length) {
        ...
        if (index != lastIndex) {
          ...
          if (newValue === void 0) {
            newValue = isObject5(objValue) ? objValue : isIndex2(path[index + 1]) ? [] : {};
          }
        }
...
// node_modules/@strapi/admin/dist/admin/index-4iCJ7_08.mjs
...
var Query = function() {
  ...
  _proto.reducer = function reducer4(state, action) {
...
// node_modules/@strapi/admin/dist/admin/useEnterprise-jpsYZWzn.mjs
...
// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/utils.mjs
function $2b4dce13dd5a17fa$export$842a2cf37af977e1(amount, numerator) {
  return amount - numerator * Math.floor(amount / numerator);
}

// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/GregorianCalendar.mjs
...
// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/queries.mjs
...
// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/conversion.mjs
function $11d87f3f76e88657$export$bd4fb2bc8bb06fb(date2) {
  date2 = $11d87f3f76e88657$export$b4a036af3fc0b032(date2, new (0, $3b62074eb05584b2$export$80ee6245ec4f29ec)());
  let year = (0, $3b62074eb05584b2$export$c36e0ecb2d4fa69d)(date2.era, date2.year);
...
function $11d87f3f76e88657$export$b21e0b124e224484(date2, time) {
  ...
  if ("timeZone" in date2)
    ({ hour, minute, second, millisecond } = date2);
  else if ("hour" in date2 && !time)
    return date2;
  if (time)
    ({ hour, minute, second, millisecond } = time);
  return new (0, $35ea8db9cb2ccb90$export$ca871e8dbb80966f)(date2.calendar, date2.era, date2.year, date2.month, date2.day, hour, minute, second, millisecond);
}
function $11d87f3f76e88657$export$b4a036af3fc0b032(date2, calendar) {
  if (date2.calendar.identifier === calendar.identifier)
    return date2;
...
function $11d87f3f76e88657$export$84c95a83c799e074(date2, timeZone, disambiguation) {
  if (date2 instanceof (0, $35ea8db9cb2ccb90$export$d3b7288e7994edea)) {
    if (date2.timeZone === timeZone)
      return date2;
...
// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/manipulation.mjs
...
function $735220c2d4774dd3$export$e16d8520af44a096(date2, duration) {
  ...
  if (mutableDate.calendar.balanceYearMonth)
    mutableDate.calendar.balanceYearMonth(mutableDate, date2);
...
function $735220c2d4774dd3$var$addYears(date2, years) {
  ...
  if ((_date_calendar_isInverseEra = (_date_calendar = date2.calendar).isInverseEra) === null || _date_calendar_isInverseEra === void 0 ? void 0 : _date_calendar_isInverseEra.call(_date_calendar, date2))
    years = -years;
  date2.year += years;
}
...
function $735220c2d4774dd3$export$c4e2ecac49351ef2(date2) {
  if (date2.calendar.constrainDate)
    date2.calendar.constrainDate(date2);
...
// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/string.mjs
...
function $fae977aafc393c5c$export$5adfdab05168c219(value, timeZone) {
  ...
  let date2 = new (0, $35ea8db9cb2ccb90$export$d3b7288e7994edea)($fae977aafc393c5c$var$parseNumber(m[1], 1, 9999), $fae977aafc393c5c$var$parseNumber(m[2], 1, 12), 1, timeZone, 0, m[4] ? $fae977aafc393c5c$var$parseNumber(m[4], 0, 23) : 0, m[5] ? $fae977aafc393c5c$var$parseNumber(m[5], 0, 59) : 0, m[6] ? $fae977aafc393c5c$var$parseNumber(m[6], 0, 59) : 0, m[7] ? $fae977aafc393c5c$var$parseNumber(m[7], 0, Infinity) * 1e3 : 0);
  date2.day = $fae977aafc393c5c$var$parseNumber(m[3], 0, date2.calendar.getDaysInMonth(date2));
  var _m_;
  if (m[8])
    date2.offset = $fae977aafc393c5c$var$parseNumber(m[8], -23, 23) * 36e5 + $fae977aafc393c5c$var$parseNumber((_m_ = m[9]) !== null && _m_ !== void 0 ? _m_ : "0", 0, 59) * 6e4;
  return (0, $11d87f3f76e88657$export$538b00033cc11c75)(date2, timeZone);
}
...
function $fae977aafc393c5c$export$60dfd74aa96791bd(date2) {
  let gregorianDate = (0, $11d87f3f76e88657$export$b4a036af3fc0b032)(date2, new (0, $3b62074eb05584b2$export$80ee6245ec4f29ec)());
...
// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/CalendarDate.mjs
...
// node_modules/@strapi/admin/node_modules/@internationalized/date/dist/HebrewCalendar.mjs
...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-J8A48xdo-UTDYYWEJ.js");
      return {
...
var SETTINGS_LINKS_CE = () => {
  ...
  return {
    ...
    admin: [
      ...
      ...!window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) && ((_d = (_c = window.strapi) == null ? void 0 : _c.flags) == null ? void 0 : _d.promoteEE) ? [
        {
          intlLabel: { id: "global.auditLogs", defaultMessage: "Audit Logs" },
...
var HistoryProvider = ({ children }) => {
  ...
  const [state, dispatch] = React10.useReducer(reducer$2, {
    history: [],
    currentLocationIndex: 0,
    currentLocation: "",
    canGoBack: false
...
var reducer$2 = (state, action) => fn(state, (draft) => {
  switch (action.type) {
    case "PUSH_STATE": {
...
var BackButton = React10.forwardRef(({ disabled }, ref) => {
...
var GuidedTourProvider = ({ children }) => {
  const [{ currentStep, guidedTourState, isGuidedTourVisible, isSkipped }, dispatch] = React10.useReducer(reducer$1, initialState, initialiseState);
...
var reducer$1 = (state = initialState, action) => fn(state, (draftState) => {
  switch (action.type) {
      ...
      Flex,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsxs)(Flex, { gap: 4, direction: "column", width: "100%", children: [
            ...
            (0, import_jsx_runtime.jsx)(Button, { onClick: handleClick, variant: "tertiary", startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$3F, {}), children: formatMessage({
              id: "app.error.copy",
...
var NotFoundPage = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Main, { labelledBy: "title", children: [
    ...
    (0, import_jsx_runtime.jsx)(Layouts.Content, { children: (0, import_jsx_runtime.jsx)(
      EmptyStateLayout,
      {
        action: (0, import_jsx_runtime.jsx)(LinkButton, { tag: Link, variant: "secondary", endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4X, {}), to: "/", children: formatMessage({
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-9Y5APon--VTDYDKCX.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-SoYGwm82-ZJCV7EL4.js");
        return {
...
var Form2 = React10.forwardRef(
  ({ disabled = false, method, onSubmit, initialErrors, ...props }, ref) => {
    ...
    const [state, dispatch] = React10.useReducer(reducer3, {
...
var reducer3 = (state, action) => fn(state, (draft) => {
...
var DateInput = (0, import_react10.forwardRef)(
    ...
    return (0, import_jsx_runtime.jsxs)(Field.Root, { error: field.error, name, hint, required, children: [
      ...
      (0, import_jsx_runtime.jsx)(
        DatePicker$1,
        {
          ...
          onChange: (date2) => {
            field.onChange(name, date2 ? convertLocalDateToUTCDate(date2) : null);
          },
...
var convertLocalDateToUTCDate = (date2) => {
...
var MemoizedDateInput = (0, import_react10.memo)(DateInput);
    ...
    return (0, import_jsx_runtime.jsxs)(Field.Root, { error: field.error, name, hint, required, children: [
      ...
      (0, import_jsx_runtime.jsx)(
        DateTimePicker,
        {
          ...
          clearLabel: formatMessage({ id: "clearLabel", defaultMessage: "Clear" }),
          onChange: (date2) => {
            field.onChange(name, date2 ? date2 : null);
          },
          onClear: () => field.onChange(name, null),
          value,
          ...props
        ...
        TextInput,
        {
          ...
          endAction: (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              type: "button",
              children: showPassword ? (0, import_jsx_runtime.jsx)(ForwardRef$3r, { fill: "neutral500" }) : (0, import_jsx_runtime.jsx)(ForwardRef$3p, { fill: "neutral500" })
            }
          ),
          onChange: field.onChange,
          defaultValue: field.initialValue,
...
var LOGIN_SCHEMA = create7().shape({
  ...
  password: create4().required(errorsTrads.required),
...
var REGISTER_USER_SCHEMA = create7().shape({
  firstname: create4().trim().required(errorsTrads.required),
    ...
    (0, import_jsx_runtime.jsx)(
      Form2,
      {
        ...
        children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, marginTop: 7, children: [
          ...
          ].map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(MemoizedInputRenderer, { ...field }) }, field.name)) }),
...
var AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-StNvuHl2-BAIFMFIJ.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-JnuNds5i-PO5X3HW5.js")).FORMS,
    {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-uSjUZ61P-DID2UXZT.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-4aSBZ-8M-LN3E5O5L.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-Qp1c1eXd-AYWRPMCU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-hyar31Ge-W57OIG65.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-hHV9CNBD-D5SE2UPB.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-5Lsxkk31-3YUQS6UN.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-cMbU4NVE-LKIYWQ2E.js").then((n) => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-3OjwvR-r-GHHSZXZK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-Hx1s5o_O-MG7QHSPI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-u0mACDyv-NOI6QO42.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-tTqJWPbg-QIU4YH34.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-qzRvLGBC-2RYRPQUD.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-NUg6w25H-CCMYLJM2.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-cnGxE7oC-WLBIGHMB.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-amcjjsft-YJU2HY5V.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-2jOz2dDs-LGTWCJ4J.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-z6GrO4cL-7G7W2DMX.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-kxpv-2IT-DLV3X3MQ.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-5ix1J-t3-FEWKZIVC.js");
      return {
  ...
  },
  {
    path: "list-plugins",
    lazy: async () => {
      const { ProtectedInstalledPluginsPage } = await import("./InstalledPluginsPage-nryUCDD3-4P5TC4F4.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-0HLsOYU8-5ZHD55ZK.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-Z093DFKa-77LCTDX6.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-_QAWr13m-CESHFT7Z.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-DhxlhqLg-B7Y33VTC.js");
              return {
...
var StrapiApp = class {
  constructor({ config, appPlugins } = {}) {
    ...
    __publicField(this, "addReducers", (reducers) => {
      Object.entries(reducers).forEach(([name, reducer4]) => {
        this.reducers[name] = reducer4;
      });
    });
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(
      this.configurations.locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/ar.json": () => import("./ar-gTQs8p7A-MTF272BK.js"), "./translations/ca.json": () => import("./ca-A-U5stlG-AJLHGTL2.js"), "./translations/cs.json": () => import("./cs-iYqoHUVt-CXXOERNS.js"), "./translations/de.json": () => import("./de-uZBjRd6a-OBVY22PV.js"), "./translations/dk.json": () => import("./dk-nXAO32DE-XKBVHCZH.js"), "./translations/en.json": () => import("./en-0Ld-ipyI-JNVLYAZ5.js"), "./translations/es.json": () => import("./es-i0dEHPPQ-EP7JBVHC.js"), "./translations/eu.json": () => import("./eu-wFmYHERY-XCJK6UP7.js"), "./translations/fr.json": () => import("./fr-OI7VyC_k-2RHOO6H3.js"), "./translations/gu.json": () => import("./gu-zSaMc-a6-3NSW2M3Q.js"), "./translations/he.json": () => import("./he-YzAGShlQ-RRUQ546J.js"), "./translations/hi.json": () => import("./hi-ZQ4t6UdY-FEKVTBD3.js"), "./translations/hu.json": () => import("./hu-O1FJoY8c-ZSSNL7NI.js"), "./translations/id.json": () => import("./id-Lb_0kPQU-3PW3C656.js"), "./translations/it.json": () => import("./it-136monzD-2XTQQ52Z.js"), "./translations/ja.json": () => import("./ja-0-FUC0T4-RIM22IW6.js"), "./translations/ko.json": () => import("./ko-H3Y8GpnD-TS4I3YOK.js"), "./translations/ml.json": () => import("./ml-NPdcpJoN-BPIZCB7R.js"), "./translations/ms.json": () => import("./ms-v9c434YI-IOTCXSD5.js"), "./translations/nl.json": () => import("./nl-qHmOt3d1-LW6T7KK4.js"), "./translations/no.json": () => import("./no-XGZQN-Ji-D5Z6P6OT.js"), "./translations/pl.json": () => import("./pl-Id5YX-Pw-D3TNEKW4.js"), "./translations/pt-BR.json": () => import("./pt-BR-0o0Gf-P8-6WU4E57W.js"), "./translations/pt.json": () => import("./pt-f52AXrxz-UTU6ANP4.js"), "./translations/ru.json": () => import("./ru-FpmG9SEf-VJQO7XDC.js"), "./translations/sa.json": () => import("./sa-KUwV8aRB-BCJGLP2H.js"), "./translations/sk.json": () => import("./sk-g_1C955P-T6UKYJJ2.js"), "./translations/sv.json": () => import("./sv-lzyY1dsz-E6T56D2E.js"), "./translations/th.json": () => import("./th-7LJ9Y8EL-XJLYLKES.js"), "./translations/tr.json": () => import("./tr-09v-DLMg-IAZC7A7S.js"), "./translations/uk.json": () => import("./uk-38IblmOr-B5752PJY.js"), "./translations/vi.json": () => import("./vi-ryNZtXtk-LFFSX2NG.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-HlxDUeVA-TFZ4KNXJ.js"), "./translations/zh.json": () => import("./zh-WEteLuNm-NSTKIB5K.js") }), `./translations/${locale}.json`);
          return { data, locale };
        } catch {
...
var useQueryParams = (initialParams) => {
  ...
  const setQuery = (0, import_react10.useCallback)(
    (nextParams, method = "push", replace3 = false) => {
      let nextQuery = { ...query };
      if (method === "remove") {
      ...
      navigate({ search: (0, import_qs.stringify)(nextQuery, { encode: false }) }, { replace: replace3 });
    },
    [navigate, query]
  );
...
var AttributeTag = ({
  ...
  return (0, import_jsx_runtime.jsx)(Tag, { padding: 1, onClick: handleClick, icon: (0, import_jsx_runtime.jsx)(ForwardRef$3V, {}), children: content });
};
var Filters = {
  List,
  Popover: PopoverImpl,
...
var HeaderCell = ({ name, label, sortable }) => {
  ...
  return (0, import_jsx_runtime.jsx)(
    Th,
    {
      action: isSorted && sortable && (0, import_jsx_runtime.jsx)(IconButton, { label: sortLabel, onClick: handleClickSort, borderStyle: "none", children: (0, import_jsx_runtime.jsx)(SortIcon, { $isUp: sortOrder === "ASC" }) }),
...
function useInjectReducer(namespace, reducer4) {
  const store = useTypedStore();
  (0, import_react10.useEffect)(() => {
    store.injectReducer(namespace, reducer4);
  }, [store, namespace, reducer4]);
}
var useFetchClient = () => {
...
//# sourceMappingURL=chunk-AZIOSPER.js.map
