import {
  ...
  STATES,
  VerticalDivider
} from "./chunk-53LW7HAT.js";
import {
  ContentBox
} from "./chunk-4C6FVP3J.js";
import {
  Layouts,
  useEnterprise,
  useGuidedTour
...
// node_modules/@strapi/admin/dist/admin/HomePage-kxpv-2IT.mjs
  ...
  const sections = Object.entries(LAYOUT_DATA).map(([key, val]) => ({
    ...
    content: (0, import_jsx_runtime.jsx)(
      LinkButton,
      {
        ...
        endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4X, {}),
  ...
  return (0, import_jsx_runtime.jsxs)(Layouts.Root, { children: [
    ...
    (0, import_jsx_runtime.jsxs)(Main, { children: [
      ...
      (0, import_jsx_runtime.jsxs)(Box, { padding: 10, children: [
        (0, import_jsx_runtime.jsx)(Grid.Root, { children: (0, import_jsx_runtime.jsx)(Grid.Item, { col: 8, s: 12, children: (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(Box, { paddingLeft: 6, paddingBottom: 10, children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "flex-start", gap: 5, children: [
          ...
          }) }) : (0, import_jsx_runtime.jsx)(Button, { size: "L", onClick: handleClick, endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4X, {}), children: formatMessage({
            id: "app.components.HomePage.create",
            defaultMessage: "Create your first Content type"
          }) })
        ] }) }) }) }) }),
        (0, import_jsx_runtime.jsxs)(Grid.Root, { gap: 6, children: [
          (0, import_jsx_runtime.jsx)(Grid.Item, { col: 8, s: 12, children: showGuidedTour ? (0, import_jsx_runtime.jsx)(GuidedTourHomepage, {}) : (0, import_jsx_runtime.jsx)(ContentBlocks, {}) }),
          (0, import_jsx_runtime.jsx)(Grid.Item, { col: 4, s: 12, children: (0, import_jsx_runtime.jsx)(SocialLinks, {}) })
        ] })
      ] })
    ] })
  ] });
    ...
    Flex,
    {
      ...
      children: [
        (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 5, children: [
          ...
          (0, import_jsx_runtime.jsx)(Link, { href: "https://feedback.strapi.io/", isExternal: true, endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$3t, {}), children: formatMessage({
        ...
        (0, import_jsx_runtime.jsx)(GridGap, { children: socialLinksExtended.map(({ icon, link, name }) => {
          return (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, s: 12, children: (0, import_jsx_runtime.jsx)(LinkCustom, { size: "L", startIcon: icon, variant: "tertiary", href: link, isExternal: true, children: formatMessage(name) }) }, name.id);
        }) })
      ]
    }
  );
...
var HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import("./HomePage-iOCLC8T5-DWHX25XM.js")).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=chunk-3IWNXYKK.js.map
