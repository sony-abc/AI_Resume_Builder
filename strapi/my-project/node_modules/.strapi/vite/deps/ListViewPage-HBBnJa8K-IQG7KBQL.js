...
// node_modules/@strapi/content-manager/dist/_chunks/ListViewPage-HBBnJa8K.mjs
...
var RepeatableComponent = ({ content, mainField }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Menu.Root, { children: [
    (0, import_jsx_runtime.jsxs)(MenuTrigger$1, { onClick: (e) => e.stopPropagation(), children: [
...
var MenuTrigger$1 = dt(Menu.Trigger)`
  svg {
    width: 0.6rem;
    height: 0.4rem;
  }
...
var RelationMultiple = ({ mainField, content, rowId, name }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Menu.Root, { onOpenChange: (isOpen2) => setIsOpen(isOpen2), children: [
    (0, import_jsx_runtime.jsx)(MenuTrigger, { onClick: (e) => e.stopPropagation(), children: (0, import_jsx_runtime.jsxs)(Flex, { gap: 1, wrap: "nowrap", children: [
      (0, import_jsx_runtime.jsx)(Badge, { children: content.count }),
      formatMessage(
        {
          id: "content-manager.containers.list.items",
          defaultMessage: "{number, plural, =0 {items} one {item} other {items}}"
...
var CellContent = ({ content, mainField, attribute, rowId, name }) => {
  if (!hasContent(content, mainField, attribute)) {
    return (0, import_jsx_runtime.jsx)(Typography, { textColor: "neutral800", children: "-" });
  }
...
var FieldPicker = ({ headers = [], resetHeaders, setHeaders }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { tag: "fieldset", direction: "column", alignItems: "stretch", gap: 3, borderWidth: 0, children: [
...
var ListViewPage = () => {
  ...
  }, [displayedHeaders, formatMessage, list, runHookWaterfall, (_a = schema == null ? void 0 : schema.options) == null ? void 0 : _a.draftAndPublish]);
  if (isFetching) {
...
//# sourceMappingURL=ListViewPage-HBBnJa8K-IQG7KBQL.js.map
