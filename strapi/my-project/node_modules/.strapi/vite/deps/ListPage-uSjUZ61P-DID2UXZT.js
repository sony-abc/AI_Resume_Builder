...
// node_modules/@strapi/admin/dist/admin/ListPage-uSjUZ61P.mjs
    ...
    Tr,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Td, { children: (0, import_jsx_runtime.jsx)(Flex, { justifyContent: "flex-end", onClick: (e) => e.stopPropagation(), children: icons.map((icon, i) => {
          if (icon) {
            return (0, import_jsx_runtime.jsx)(Box, { paddingLeft: i === 0 ? 0 : 1, children: (0, import_jsx_runtime.jsx)(IconButton, { ...icon, borderWidth: 0 }) }, icon.label);
          }
          return null;
        }) }) })
      ]
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Main, { children: [
    ...
    canRead && (0, import_jsx_runtime.jsx)(Layouts.Content, { children: (0, import_jsx_runtime.jsxs)(
      Table,
      {
        colCount,
        rowCount,
        footer: canCreate ? (0, import_jsx_runtime.jsx)(TFooter, { onClick: handleNewRoleClick, icon: (0, import_jsx_runtime.jsx)(ForwardRef$1d, {}), children: formatMessage({
          id: "Settings.roles.list.button.add",
          defaultMessage: "Add new role"
        }) }) : null,
        children: [
...
//# sourceMappingURL=ListPage-uSjUZ61P-DID2UXZT.js.map
