...
// node_modules/@strapi/admin/dist/admin/Permissions-oxdduJgE.mjs
...
`;
var CarretIcon = dt(ForwardRef$4D)`
  display: none;
...
var ConditionsButtonImpl = React.forwardRef(
  ({ onClick, className, hasConditions = false, variant = "tertiary" }, ref) => {
    const { formatMessage } = useIntl();
    return (0, import_jsx_runtime.jsx)(ButtonContainer, { $hasConditions: hasConditions, className, children: (0, import_jsx_runtime.jsx)(Button, { variant, startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$41, {}), onClick, ref, children: formatMessage({
      id: "global.settings",
...
var ActionRow = ({
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { tag: "li", background: isGrey ? "neutral100" : "neutral0", paddingBottom: 3, paddingTop: 3, children: [
    (0, import_jsx_runtime.jsxs)(Flex, { paddingLeft: 6, style: { width: 180 }, children: [
        ...
        children: [
          (0, import_jsx_runtime.jsx)(
            RowLabelWithCheckbox,
            {
              ...
              value: hasAllActionsSelected,
              isActive,
              children: (0, import_jsx_runtime.jsx)(Chevron, { paddingLeft: 2, children: isActive ? (0, import_jsx_runtime.jsx)(ForwardRef$4f, {}) : (0, import_jsx_runtime.jsx)(ForwardRef$4l, {}) })
            }
          ),
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsxs)(Box, { children: [
    ...
    (0, import_jsx_runtime.jsxs)(Flex, { paddingTop: 6, paddingBottom: 6, children: [
      (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 2, style: { flex: 1 }, children: formattedActions.map(({ checkboxName, value, action, displayName, hasConditions }) => {
        return (0, import_jsx_runtime.jsx)(Grid.Item, { col: 3, children: (0, import_jsx_runtime.jsx)(CheckboxWrapper, { $disabled: isFormDisabled, $hasConditions: hasConditions, children: (0, import_jsx_runtime.jsx)(
          CheckboxImpl,
          {
            name: checkboxName,
            disabled: isFormDisabled,
...
//# sourceMappingURL=chunk-RZXKFKV3.js.map
