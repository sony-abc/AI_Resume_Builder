...
// node_modules/@strapi/i18n/dist/_chunks/index-CCZJF_EJ.mjs
...
var EntryValidationText = ({ status = "draft", validationErrors }) => {
  const { formatMessage } = useIntl();
    ...
    (0, import_jsx_runtime.jsx)(Box, { marginTop: 5, children: (0, import_jsx_runtime.jsxs)(Table.Content, { children: [
      ...
      (0, import_jsx_runtime.jsx)(Table.Body, { children: rows.map(({ locale, status }, index2) => {
        ...
        return (0, import_jsx_runtime.jsxs)(Table.Row, { children: [
          ...
          (0, import_jsx_runtime.jsx)(Table.Cell, { children: (0, import_jsx_runtime.jsx)(EntryValidationText, { validationErrors: error, status }) }),
...
var LocalePickerAction = ({
  ...
  }, [handleSelect, hasI18n, locales, (_b = (_a = query.plugins) == null ? void 0 : _a.i18n) == null ? void 0 : _b.locale]);
  if (!hasI18n || !Array.isArray(locales) || locales.length === 0) {
    return null;
  }
  const currentLocale = ((_d = (_c = query.plugins) == null ? void 0 : _c.i18n) == null ? void 0 : _d.locale) || ((_e = locales.find((loc) => loc.isDefault)) == null ? void 0 : _e.code);
...
var BulkLocalePublishAction = ({
  ...
  const isUnpublish = (document == null ? void 0 : document.status) === "published";
  if (isUnpublish) {
...
var LocaleListCell = ({
  ...
  return (0, import_jsx_runtime.jsxs)(Popover.Root, { children: [
    (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsx)(Button2, { type: "button", onClick: (e) => e.stopPropagation(), children: (0, import_jsx_runtime.jsxs)(
      ActionWrapper,
      {
        minWidth: "100%",
        alignItems: "center",
        ...
        width: "3.2rem",
        children: [
          (0, import_jsx_runtime.jsx)(Typography, { textColor: "neutral800", ellipsis: true, children: localesForDocument.join(", ") }),
          (0, import_jsx_runtime.jsx)(Flex, { children: (0, import_jsx_runtime.jsx)(ForwardRef$4D, {}) })
        ]
      }
    ) }) }),
...
var index = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-CsGvujny-OUEOF65G.js").then((mod) => ({ default: mod.ProtectedSettingsPage })),
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/de.json": () => import("./de-9eCAqqrB-DIKNJRVS.js"), "./translations/dk.json": () => import("./dk-2qBjxt-P-4UCWN4LW.js"), "./translations/en.json": () => import("./en-CM6Pjfyv-ZKOBLDDS.js"), "./translations/es.json": () => import("./es-DlmMVaBG-LME6H2BI.js"), "./translations/fr.json": () => import("./fr-3S6ke71d-G6MKIIOM.js"), "./translations/ko.json": () => import("./ko-qTjQ8IMw-TJAF4GJ5.js"), "./translations/pl.json": () => import("./pl-B67TSHqT-Y27R7J4E.js"), "./translations/ru.json": () => import("./ru-hagMa57T-SAU2A6I4.js"), "./translations/tr.json": () => import("./tr-Dw_jmkG--U64YYHME.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-Dyc-aR-h-BRU2ZDHC.js"), "./translations/zh.json": () => import("./zh-57YM4amO-DSRSNHHU.js") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-WJKRBLN2.js.map
