...
// node_modules/@strapi/review-workflows/dist/_chunks/index-CtpGMTO2.mjs
...
var Panel = () => {
  ...
  const { formatMessage } = useIntl();
  if (!window.strapi.isEE || !(options == null ? void 0 : options.reviewWorkflows) || !id || id === "create") {
    return null;
  }
  return {
    title: formatMessage({
...
var admin = {
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-C6NXX9-N-4WTEWHXY.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-BN-5Ube7-6F3B4W22.js");
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en.json": () => import("./en-D9ZrQAV6-DU655MEY.js") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-GG6TWRVZ.js.map
