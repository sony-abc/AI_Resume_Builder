...
// node_modules/@strapi/review-workflows/dist/_chunks/_id-AtadE_bb.mjs
    ...
    isDragging ? (0, import_jsx_runtime.jsx)(
      ...
      AccordionRoot,
      {
        ...
        children: (0, import_jsx_runtime.jsxs)(Accordion.Item, { value: id, children: [
          ...
          ].map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(InputRenderer, { ...field }) }, field.name)) }) })
        ] })
      }
    )
  ] });
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)(
            TextInput,
            {
              ...
              startAction: (0, import_jsx_runtime.jsx)(ForwardRef$3p, { fill: "neutral600" }),
              type: "text",
              value: ""
            }
          ),
...
var WorkflowAttributes = ({ canUpdate = true }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Grid.Root, { background: "neutral0", hasRadius: true, gap: 4, padding: 6, shadow: "tableShadow", children: [
    ...
    (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, children: (0, import_jsx_runtime.jsx)(ContentTypesSelector, { disabled: !canUpdate }) })
  ] });
};
      ...
      if (!isCreatingWorkflow) {
        const res = await update(id, {
          ...
          stages: data.stages.map((stage) => {
            ...
            const serverStage = (_a = currentWorkflow == null ? void 0 : currentWorkflow.stages) == null ? void 0 : _a.find(
            ...
            if (serverStage) {
              hasUpdatedPermissions = ((_b = serverStage.permissions) == null ? void 0 : _b.length) !== ((_c = stage.permissions) == null ? void 0 : _c.length) || !((_d = serverStage.permissions) == null ? void 0 : _d.every(
                (serverPermission) => {
                  var _a2;
                  return !!((_a2 = stage.permissions) == null ? void 0 : _a2.find(
...
//# sourceMappingURL=_id-AtadE_bb-E2PJ4W5L.js.map
