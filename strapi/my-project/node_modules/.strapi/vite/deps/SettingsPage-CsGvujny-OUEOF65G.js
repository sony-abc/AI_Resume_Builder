...
// node_modules/@strapi/i18n/dist/_chunks/SettingsPage-CsGvujny.mjs
...
var SubmitButton = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Button, { type: "submit", startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4p, {}), disabled: isSubmitting || !modified, children: formatMessage({ id: "global.save", defaultMessage: "Save" }) });
};
var BaseForm = ({ mode = "create" }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, children: translatedForm.map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(FormRenderer, { ...field }) }, field.name)) });
};
var AdvancedForm = ({ isDefaultLocale }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, children: form.map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(FormRenderer, { ...field }) }, field.name)) });
};
...
//# sourceMappingURL=SettingsPage-CsGvujny-OUEOF65G.js.map
