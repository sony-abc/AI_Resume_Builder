...
} from "./chunk-QUJ5PYDA.js";
import {
  require_pluralize
} from "./chunk-O6QFUROF.js";
import {
  require_groupBy
} from "./chunk-3IQ7KD5P.js";
import {
  formatISO
} from "./chunk-CRFUNQNX.js";
import {
  ConfirmDialog,
  Layouts,
  create3 as create,
...
// node_modules/@strapi/content-type-builder/dist/_chunks/index-DuI_0sF6.mjs
  ...
  return isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? (0, import_react_dom.createPortal)(
    (0, import_jsx_runtime.jsxs)(Overlay, { id: "autoReloadOverlayBlocker", direction: "column", alignItems: "center", gap: 6, children: [
      (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "center", gap: 2, children: [
        ...
        (0, import_jsx_runtime.jsx)(Typography, { tag: "h2", textColor: "neutral600", fontSize: 4, fontWeight: "regular", children: formatMessage(description) })
      ] }),
      displayedIcon === "reload" && (0, import_jsx_runtime.jsx)(IconBox$1, { padding: 6, background: "primary100", borderColor: "primary200", children: (0, import_jsx_runtime.jsx)(LoaderReload, { width: "3.6rem", height: "3.6rem" }) }),
      displayedIcon === "time" && (0, import_jsx_runtime.jsx)(IconBox$1, { padding: 6, background: "primary100", borderColor: "primary200", children: (0, import_jsx_runtime.jsx)(ForwardRef$4d, { width: "4rem", height: "4rem" }) }),
      (0, import_jsx_runtime.jsx)(Box, { marginTop: 2, children: (0, import_jsx_runtime.jsx)(Link2, { href: "https://docs.strapi.io", isExternal: true, children: formatMessage({
...
var rotation = mt`
  ...
  `;
var LoaderReload = dt(ForwardRef$51)`
...
var AttributeList = ({ attributes }) => (0, import_jsx_runtime.jsx)(KeyboardNavigable, { tagName: "button", children: (0, import_jsx_runtime.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 8, children: attributes.map((attributeRow, index2) => {
  return (
    ...
    (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 3, children: attributeRow.map((attribute) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, children: (0, import_jsx_runtime.jsx)(AttributeOption, { type: attribute }) }, attribute)) }, index2)
  );
}) }) });
var CustomFieldOption = ({ customFieldUid, customField }) => {
  ...
  return (0, import_jsx_runtime.jsx)(OptionBoxWrapper, { padding: 4, tag: "button", hasRadius: true, type: "button", onClick: handleClick, children: (0, import_jsx_runtime.jsxs)(Flex, { children: [
    ...
    (0, import_jsx_runtime.jsxs)(Box, { paddingLeft: 4, children: [
      (0, import_jsx_runtime.jsx)(Flex, { children: (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "bold", children: formatMessage(intlLabel) }) }),
...
var CustomFieldsList = () => {
  ...
  return (0, import_jsx_runtime.jsx)(KeyboardNavigable, { tagName: "button", children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 3, children: [
    (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 3, children: sortedCustomFields.map(([uid, customField]) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, children: (0, import_jsx_runtime.jsx)(CustomFieldOption, { customFieldUid: uid, customField }, uid) }, uid)) }),
    (0, import_jsx_runtime.jsx)(
      Link2,
      {
...
var DraftAndPublishToggle = ({
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    (0, import_jsx_runtime.jsx)(Dialog.Root, { open: showWarning, onOpenChange: (isOpen) => setShowWarning(isOpen), children: (0, import_jsx_runtime.jsx)(ConfirmDialog, { onConfirm: handleConfirm, children: formatMessage({
...
var COMPONENT_ICONS = {
  alien: ForwardRef$55,
  apps: ForwardRef$31,
  archive: ForwardRef$53,
  arrowDown: ForwardRef$4$,
  arrowLeft: ForwardRef$4Z,
  arrowRight: ForwardRef$4X,
  arrowUp: ForwardRef$4V,
  attachment: ForwardRef$1v,
  bell: ForwardRef$4R,
  bold: ForwardRef$4P,
  book: ForwardRef$4N,
  briefcase: ForwardRef$4L,
  brush: ForwardRef$1D,
  bulletList: ForwardRef$4J,
  calendar: ForwardRef$4H,
  car: ForwardRef$4F,
  cast: ForwardRef$4z,
  chartBubble: ForwardRef$4v,
  chartCircle: ForwardRef$4t,
  chartPie: ForwardRef$4r,
  check: ForwardRef$4p,
  clock: ForwardRef$4d,
  cloud: ForwardRef$49,
  code: ForwardRef$45,
  cog: ForwardRef$41,
  collapse: ForwardRef$3$,
  command: ForwardRef$3Z,
  connector: ForwardRef$3n,
  crop: ForwardRef$3X,
  crown: ForwardRef$3R,
  cup: ForwardRef$43,
  cursor: ForwardRef$3P,
  dashboard: ForwardRef$F,
  database: ForwardRef$3N,
  discuss: ForwardRef$3L,
  doctor: ForwardRef$z,
  earth: ForwardRef$3D,
  emotionHappy: ForwardRef$3z,
  emotionUnhappy: ForwardRef$3x,
  envelop: ForwardRef$29,
  exit: ForwardRef$L,
  expand: ForwardRef$3v,
  eye: ForwardRef$3r,
  feather: ForwardRef$3l,
  file: ForwardRef$3j,
  fileError: ForwardRef$3h,
  filePdf: ForwardRef$3f,
  ...
  quote: ForwardRef$11,
  refresh: ForwardRef$51,
  restaurant: ForwardRef$$,
  rocket: ForwardRef$Z,
  rotate: ForwardRef$4T,
    ...
    return (0, import_jsx_runtime.jsxs)(Box, { children: [
      ...
      (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, children: section.items.map((input, i) => {
        ...
        if (input.type === "pushRight") {
          return (0, import_jsx_runtime.jsx)(Grid.Item, { col: input.size || 6, children: (0, import_jsx_runtime.jsx)("div", {}) }, input.name || key);
        }
        return (0, import_jsx_runtime.jsx)(Grid.Item, { col: input.size || 6, children: (0, import_jsx_runtime.jsx)(
          MemoizedGenericInput,
          {
            ...input,
            ...genericInputProps,
...
var FormModal = () => {
    ...
    if (isOpen) {
      ...
      if (modalType === "contentType" && actionType === "edit") {
        const {
          ...
          reviewWorkflows,
          singularName
        } = (0, import_get.default)(allDataSchema, [...pathToSchema, "schema"], {
          displayName: null,
          pluginOptions: {},
          singularName: null,
          pluralName: null
  ...
  return (0, import_jsx_runtime.jsx)(Modal.Root, { open: isOpen, onOpenChange: handleClosed, children: (0, import_jsx_runtime.jsxs)(Modal.Content, { children: [
    ...
    !isPickingAttribute && (0, import_jsx_runtime.jsxs)("form", { onSubmit: handleSubmit, children: [
...
var ListView$1 = (0, import_react.lazy)(() => import("./ListView-B6MnxBt0-LIZHCPWQ.js"));
var RecursivePath = () => {
...
var ListView = (0, import_react.lazy)(() => import("./ListView-B6MnxBt0-LIZHCPWQ.js"));
var App = () => {
  const { formatMessage } = useIntl();
...
lodash/lodash.min.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-43KNWNIQ.js.map
