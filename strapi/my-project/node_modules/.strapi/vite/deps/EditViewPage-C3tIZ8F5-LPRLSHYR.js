...
// node_modules/@strapi/content-manager/dist/_chunks/EditViewPage-C3tIZ8F5.mjs
...
var FormLayout = ({ layout }) => {
  return (0, import_jsx_runtime.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: layout.map((panel, index) => {
    if (panel.some((row) => row.some((field) => field.type === "dynamiczone"))) {
      const [row] = panel;
      const [field] = row;
      return (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, children: (0, import_jsx_runtime.jsx)(Grid.Item, { col: 12, s: 12, xs: 12, children: (0, import_jsx_runtime.jsx)(MemoizedInputRenderer, { ...field }) }) }, field.name);
    }
    return (0, import_jsx_runtime.jsx)(
      Box,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: panel.map((row, gridRowIndex) => (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, children: row.map(({ size, ...field }) => {
          return (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, s: 12, xs: 12, children: (0, import_jsx_runtime.jsx)(MemoizedInputRenderer, { ...field }) }, field.name);
        }) }, gridRowIndex)) })
      },
      index
    );
...
var EditViewPage = () => {
  ...
  const documentTitle = mainField !== "id" && (document == null ? void 0 : document[mainField]) ? document[mainField] : "Untitled";
  return (0, import_jsx_runtime.jsxs)(Main, { paddingLeft: 10, paddingRight: 10, children: [
    ...
    (0, import_jsx_runtime.jsx)(
      Form,
      {
        ...
        validationSchema: createYupSchema(schema == null ? void 0 : schema.attributes, components),
        children: ({ resetForm }) => (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          ...
          (0, import_jsx_runtime.jsxs)(Tabs.Root, { variant: "simple", value: status, onValueChange: handleTabChange, children: [
            ...
            (0, import_jsx_runtime.jsxs)(Grid.Root, { paddingTop: 8, gap: 4, children: [
              (0, import_jsx_runtime.jsxs)(Grid.Item, { col: 9, s: 12, children: [
              ...
              (0, import_jsx_runtime.jsx)(Grid.Item, { col: 3, s: 12, children: (0, import_jsx_runtime.jsx)(Panels, {}) })
            ] })
          ] }),
          (0, import_jsx_runtime.jsx)(
            Blocker,
...
//# sourceMappingURL=EditViewPage-C3tIZ8F5-LPRLSHYR.js.map
