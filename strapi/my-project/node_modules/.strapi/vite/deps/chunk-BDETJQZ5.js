import {
  useWebhooks
} from "./chunk-7K6KQDFM.js";
import {
  selectAdminPermissions
} from "./chunk-XSRGYOCC.js";
import {
  BackButton,
  Form2 as Form,
  Layouts,
...
// node_modules/@strapi/admin/dist/admin/EditPage-cMbU4NVE.mjs
    ...
    (0, import_jsx_runtime.jsxs)(Box, { padding: 8, background: "neutral100", hasRadius: true, children: [
      value.map((_, index) => {
        return (0, import_jsx_runtime.jsxs)(Grid.Root, { gap: 4, padding: 2, children: [
          (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, children: (0, import_jsx_runtime.jsx)(
            HeaderCombobox,
            {
          ...
          (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, children: (0, import_jsx_runtime.jsxs)(Flex, { alignItems: "flex-end", gap: 2, children: [
            ...
            (0, import_jsx_runtime.jsx)(Flex, { paddingTop: 6, style: { alignSelf: "flex-start" }, children: (0, import_jsx_runtime.jsx)(
              IconButton,
              {
                borderRadius: "3rem",
                width: "2rem",
...
var Status = ({ isPending, statusCode }) => {
  ...
  if (statusCode >= 200 && statusCode < 300) {
    return (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, alignItems: "center", children: [
      (0, import_jsx_runtime.jsx)(ForwardRef$4p, { fill: "success700", height: "1.2rem", width: "1.2rem" }),
      (0, import_jsx_runtime.jsx)(Typography, { children: formatMessage({ id: "Settings.webhooks.trigger.success", defaultMessage: "success" }) })
    ] });
  }
  if (statusCode >= 300) {
    return (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, alignItems: "center", children: [
      (0, import_jsx_runtime.jsx)(ForwardRef$3V, { fill: "danger700", height: "1.2rem", width: "1.2rem" }),
...
var WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-bAm473aQ-B5AMVQ7I.js")).EventsTableEE
  );
...
//# sourceMappingURL=chunk-BDETJQZ5.js.map
