import {
  ComponentIcon
} from "./chunk-CM4K2NOT.js";
import {
  FieldTypeIcon
} from "./chunk-A6ZFTPOG.js";
import {
  ItemTypes,
  useDragAndDrop
} from "./chunk-Q2ZCPG4U.js";
import {
  getEmptyImage
...
// node_modules/@strapi/content-manager/dist/_chunks/Form-BZmDNVr9.mjs
  ...
  return (0, import_jsx_runtime.jsx)(Modal.Content, { children: (0, import_jsx_runtime.jsxs)(
    Form,
    {
      ...
      children: [
        ...
        ].filter(filterFieldsBasedOnAttributeType(attribute.type)).map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(MemoizedInputRenderer, { ...field }) }, field.name)) }) }),
...
var Fields = ({ attributes, fieldSizes, components, metadatas = {} }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { paddingTop: 6, direction: "column", alignItems: "stretch", gap: 4, children: [
    ...
    (0, import_jsx_runtime.jsx)(Box, { padding: 4, hasRadius: true, borderStyle: "dashed", borderWidth: "1px", borderColor: "neutral300", children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
      layout.map((row, rowIndex) => (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 2, children: row.children.map(({ size, ...field }, fieldIndex) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(
        Field,
        {
        ...
        children: [
          (0, import_jsx_runtime.jsx)(
            DragButton,
            {
              ...
              ref: composedRefs,
              children: (0, import_jsx_runtime.jsx)(ForwardRef$3H, {})
            }
          ),
              ...
              Flex,
              {
                ...
                children: [
                  (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 4, width: "100%", children: components[attribute.component].layout.map(
                    (row) => row.map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(
                      Flex,
                      {
                        alignItems: "center",
                        background: "neutral0",
                  ...
                  (0, import_jsx_runtime.jsx)(
                    ...
                    {
                      onClick: (e) => e.stopPropagation(),
                      startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$41, {}),
                      tag: NavLink,
      ...
      Flex,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsxs)(Grid.Root, { children: [
            (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, s: 12, children: (0, import_jsx_runtime.jsx)(
              MemoizedInputRenderer,
              {
                type: "enumeration",
                label: formatMessage({
            ...
            (0, import_jsx_runtime.jsx)(Grid.Item, { paddingTop: 6, paddingBottom: 6, col: 12, s: 12, children: (0, import_jsx_runtime.jsx)(Divider, {}) }),
            (0, import_jsx_runtime.jsx)(Grid.Item, { col: 12, s: 12, children: (0, import_jsx_runtime.jsx)(Typography, { variant: "delta", tag: "h3", children: formatMessage({
              id: getTranslation("containers.SettingPage.view"),
              defaultMessage: "View"
            }) }) }),
            (0, import_jsx_runtime.jsx)(Grid.Item, { col: 12, s: 12, children: (0, import_jsx_runtime.jsx)(
              Fields,
              {
                attributes,
                components,
...
//# sourceMappingURL=chunk-NWJCEYDI.js.map
