...
// node_modules/@strapi/admin/dist/admin/ProfilePage-5ix1J-t3.mjs
  ...
  return (0, import_jsx_runtime.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
        ...
        ].map((row, index) => (0, import_jsx_runtime.jsx)(Grid.Root, { gap: 5, children: row.map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Grid.Item, { col: size, children: (0, import_jsx_runtime.jsx)(MemoizedInputRenderer, { ...field }) }, field.name)) }, index))
      ] })
    }
  );
};
...
//# sourceMappingURL=ProfilePage-5ix1J-t3-FEWKZIVC.js.map
