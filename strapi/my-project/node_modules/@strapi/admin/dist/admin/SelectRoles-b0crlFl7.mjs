...
import { w as useClipboard, m as getBasename, u as useField } from './index-4iCJ7_08.mjs';
...
import { a as useNotification } from './Theme-PrUuuGtN.mjs';
...
const MagicLinkWrapper = ({ children, target }) => {
  ...
  return /* @__PURE__ */ jsx(
    ContentBox,
    {
      endAction: /* @__PURE__ */ jsx(IconButton, { label: copyLabel, borderWidth: 0, onClick: handleClick, children: /* @__PURE__ */ jsx(Duplicate, {}) }),
      title: target,
      titleEllipsis: true,
      subtitle: children,
...
//# sourceMappingURL=SelectRoles-b0crlFl7.mjs.map
