...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require('./AdminSeatInfo-E8azTFQY.js'))).AdminSeatInfoEE
  );
  const {
          ...
          designSystem.Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { gap: 5, tag: "dl", children: [
                /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Item, { col: 6, s: 12, children: [
...
//# sourceMappingURL=ApplicationInfoPage-DOljMjfU.js.map
