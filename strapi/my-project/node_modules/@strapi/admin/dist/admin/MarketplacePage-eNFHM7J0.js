...
const NpmPackagesFilters = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Popover.Root, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingTop: 1, paddingBottom: 1, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Popover.Trigger, { children: /* @__PURE__ */ jsxRuntime.jsx(ButtonToggle, { variant: "tertiary", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Filter, {}), size: "S", children: formatMessage({ id: "app.utils.filters", defaultMessage: "Filters" }) }) }),
...
const ButtonToggle = styledComponents.styled(designSystem.Button)`
  height: unset;
...
const NpmPackagesGrid = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Root, { gap: 4, children: npmPackages.map((npmPackage) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 4, s: 6, xs: 12, style: { height: "100%" }, children: /* @__PURE__ */ jsxRuntime.jsx(
    NpmPackageCard,
    {
      npmPackage,
...
const MarketplacePage = () => {
  ...
  const { trackUsage } = Theme.useTracking();
  const { toggleNotification } = Theme.useNotification();
  const [{ query }, setQuery] = index.useQueryParams();
...
//# sourceMappingURL=MarketplacePage-eNFHM7J0.js.map
