...
import { b as useTypedSelector, P as Page, a as useNotification, f as useAPIErrorHandler } from './Theme-PrUuuGtN.mjs';
import { s as selectAdminPermissions } from './selectors-ZpHhvPK4.mjs';
import { i as isBaseQueryError } from './admin-B6AW0Kov.mjs';
import { Minus, Plus, Cross, Loader, Check, Play } from '@strapi/icons';
import * as yup from 'yup';
import { u as useField, x as useForm, y as MemoizedStringInput, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-4iCJ7_08.mjs';
import { u as useEnterprise } from './useEnterprise-jpsYZWzn.mjs';
import { styled } from 'styled-components';
import { u as useWebhooks } from './useWebhooks-7thg-d57.mjs';
    ...
    /* @__PURE__ */ jsxs(Box, { padding: 8, background: "neutral100", hasRadius: true, children: [
      value.map((_, index) => {
        return /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, padding: 2, children: [
          ...
          /* @__PURE__ */ jsx(Grid.Item, { col: 6, children: /* @__PURE__ */ jsxs(Flex, { alignItems: "flex-end", gap: 2, children: [
            ...
            /* @__PURE__ */ jsx(Flex, { paddingTop: 6, style: { alignSelf: "flex-start" }, children: /* @__PURE__ */ jsx(
              IconButton,
              {
                borderRadius: "3rem",
                width: "2rem",
...
const TriggerContainer = ({ isPending, onCancel, response }) => {
  ...
  return /* @__PURE__ */ jsx(Box, { background: "neutral0", padding: 5, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, style: { alignItems: "center" }, children: [
    /* @__PURE__ */ jsx(Grid.Item, { col: 3, children: /* @__PURE__ */ jsx(Typography, { children: formatMessage({
      id: "Settings.webhooks.trigger.test",
      defaultMessage: "Test-trigger"
    }) }) }),
    /* @__PURE__ */ jsx(Grid.Item, { col: 3, children: /* @__PURE__ */ jsx(Status, { isPending, statusCode }) }),
    /* @__PURE__ */ jsx(Grid.Item, { col: 6, children: !isPending ? /* @__PURE__ */ jsx(Message, { statusCode, message }) : /* @__PURE__ */ jsx(Flex, { justifyContent: "flex-end", children: /* @__PURE__ */ jsx("button", { onClick: onCancel, type: "button", children: /* @__PURE__ */ jsxs(Flex, { gap: 2, alignItems: "center", children: [
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import('./EventsTable-bAm473aQ.mjs')).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-cMbU4NVE.mjs.map
