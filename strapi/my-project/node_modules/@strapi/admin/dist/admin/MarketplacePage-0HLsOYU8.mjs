...
import { Button, Popover, Box, Flex, Tag, MultiSelect, MultiSelectOption, Typography, Divider, Tooltip, LinkButton, Grid, Main, SingleSelect, SingleSelectOption, useNotifyAT, Tabs, Searchbar } from '@strapi/design-system';
...
import { z as StrapiLogo, w as useClipboard, b as Layouts, o as useQueryParams, P as Pagination } from './index-4iCJ7_08.mjs';
import { d as useTracking, a as useNotification, P as Page, b as useTypedSelector, n as useAppInfo } from './Theme-PrUuuGtN.mjs';
...
const NpmPackagesFilters = ({
  ...
  return /* @__PURE__ */ jsxs(Popover.Root, { children: [
    /* @__PURE__ */ jsxs(Box, { paddingTop: 1, paddingBottom: 1, children: [
      /* @__PURE__ */ jsx(Popover.Trigger, { children: /* @__PURE__ */ jsx(ButtonToggle, { variant: "tertiary", startIcon: /* @__PURE__ */ jsx(Filter, {}), size: "S", children: formatMessage({ id: "app.utils.filters", defaultMessage: "Filters" }) }) }),
    ...
    if (!versionRange || !isCompatible) {
      return /* @__PURE__ */ jsx(
        Tooltip,
        {
          ...
          label: !versionRange ? formatMessage(
            {
...
const NpmPackagesGrid = ({
  ...
  return /* @__PURE__ */ jsx(Grid.Root, { gap: 4, children: npmPackages.map((npmPackage) => /* @__PURE__ */ jsx(Grid.Item, { col: 4, s: 6, xs: 12, style: { height: "100%" }, children: /* @__PURE__ */ jsx(
    NpmPackageCard,
    {
      npmPackage,
...
//# sourceMappingURL=MarketplacePage-0HLsOYU8.mjs.map
