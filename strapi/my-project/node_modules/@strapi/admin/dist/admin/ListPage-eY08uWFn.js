...
const SelectRoles = require('./SelectRoles-nRbY6X9X.js');
...
const ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = useEnterprise.useEnterprise(
    ROLE_LAYOUT,
    async () => (await Promise.resolve().then(() => require('./ModalForm-wXXenEdW.js'))).ROLE_LAYOUT,
    {
  ...
  const initialValues = useEnterprise.useEnterprise(
    FORM_INITIAL_VALUES,
    async () => (await Promise.resolve().then(() => require('./ModalForm-wXXenEdW.js'))).FORM_INITIAL_VALUES,
    {
  ...
  const MagicLink = useEnterprise.useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require('./MagicLinkEE-yv0VjDUG.js'))).MagicLinkEE
  );
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Root, { gap: 5, children: FORM_LAYOUT.map((row) => {
                  return row.map(({ size, ...field }) => {
                    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: size, children: /* @__PURE__ */ jsxRuntime.jsx(
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 4, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { gap: 5, children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 6, xs: 12, children: /* @__PURE__ */ jsxRuntime.jsx(SelectRoles.SelectRoles, { disabled: isDisabled }) }),
                  roleLayout.map((row) => {
                    return row.map(({ size, ...field }) => {
                      return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: size, children: /* @__PURE__ */ jsxRuntime.jsx(
                        index.MemoizedInputRenderer,
...
const ListPageCE = () => {
  ...
  const CreateAction = useEnterprise.useEnterprise(
    CreateActionCE,
    async () => (await Promise.resolve().then(() => require('./CreateActionEE-uqyKLxwI.js'))).CreateActionEE
  );
...
const ListPage = () => {
  const UsersListPage = useEnterprise.useEnterprise(
    ...
    async () => (
      ...
      (await Promise.resolve().then(() => require('./ListPage-MQLTqMD4.js'))).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
//# sourceMappingURL=ListPage-eY08uWFn.js.map
