...
import { e as errorsTrads, s as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, t as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, v as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index-4iCJ7_08.mjs';
import { a as useNotification, f as useAPIErrorHandler, b as useTypedSelector, P as Page, k as useRBAC } from './Theme-PrUuuGtN.mjs';
import { u as useEnterprise } from './useEnterprise-jpsYZWzn.mjs';
import { g as getDisplayName } from './users-a4KTyEyc.mjs';
import * as yup from 'yup';
import { i as isBaseQueryError } from './admin-B6AW0Kov.mjs';
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-b0crlFl7.mjs';
...
const ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = useEnterprise(
    ROLE_LAYOUT,
    async () => (await import('./ModalForm-Gh2063zZ.mjs')).ROLE_LAYOUT,
    {
  ...
  const initialValues = useEnterprise(
    FORM_INITIAL_VALUES,
    async () => (await import('./ModalForm-Gh2063zZ.mjs')).FORM_INITIAL_VALUES,
    {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import('./MagicLinkEE-Enht2VEX.mjs')).MagicLinkEE
  );
            ...
            /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
              ...
              /* @__PURE__ */ jsxs(Box, { children: [
                ...
                /* @__PURE__ */ jsx(Box, { paddingTop: 4, children: /* @__PURE__ */ jsx(Flex, { direction: "column", alignItems: "stretch", gap: 1, children: /* @__PURE__ */ jsx(Grid.Root, { gap: 5, children: FORM_LAYOUT.map((row) => {
                  return row.map(({ size, ...field }) => {
                    return /* @__PURE__ */ jsx(Grid.Item, { col: size, children: /* @__PURE__ */ jsx(
              ...
              /* @__PURE__ */ jsxs(Box, { children: [
                ...
                /* @__PURE__ */ jsx(Box, { paddingTop: 4, children: /* @__PURE__ */ jsxs(Grid.Root, { gap: 5, children: [
                  /* @__PURE__ */ jsx(Grid.Item, { col: 6, xs: 12, children: /* @__PURE__ */ jsx(SelectRoles, { disabled: isDisabled }) }),
                  roleLayout.map((row) => {
                    return row.map(({ size, ...field }) => {
                      return /* @__PURE__ */ jsx(Grid.Item, { col: size, children: /* @__PURE__ */ jsx(
                        MemoizedInputRenderer,
...
const ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(
    CreateActionCE,
    async () => (await import('./CreateActionEE-Yfp4hs7a.mjs')).CreateActionEE
  );
...
const ListPage = () => {
  const UsersListPage = useEnterprise(
    ...
    async () => (
      ...
      (await import('./ListPage-v8u0mb2U.mjs')).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
//# sourceMappingURL=ListPage-hyar31Ge.mjs.map
