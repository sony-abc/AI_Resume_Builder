...
import { d as useTracking, p as useConfiguration, n as useAppInfo, k as useRBAC, P as Page } from './Theme-PrUuuGtN.mjs';
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import('./AdminSeatInfo-Q_hUNC5B.mjs')).AdminSeatInfoEE
  );
  const {
          ...
          Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs(Grid.Root, { gap: 5, tag: "dl", children: [
                /* @__PURE__ */ jsxs(Grid.Item, { col: 6, s: 12, children: [
...
//# sourceMappingURL=ApplicationInfoPage-_QAWr13m.mjs.map
