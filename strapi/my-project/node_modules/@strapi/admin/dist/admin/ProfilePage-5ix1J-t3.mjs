...
import { e as errorsTrads, F as Form, b as Layouts, M as MemoizedInputRenderer } from './index-4iCJ7_08.mjs';
import { b as useTypedSelector, d as useTracking, a as useNotification, e as useTypedDispatch, f as useAPIErrorHandler, u as useAuth, g as useUpdateMeMutation, h as useIsSSOLockedQuery, P as Page, s as setAppTheme } from './Theme-PrUuuGtN.mjs';
  ...
  return /* @__PURE__ */ jsx(
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
        ...
        ].map((row, index) => /* @__PURE__ */ jsx(Grid.Root, { gap: 5, children: row.map(({ size, ...field }) => /* @__PURE__ */ jsx(Grid.Item, { col: size, children: /* @__PURE__ */ jsx(MemoizedInputRenderer, { ...field }) }, field.name)) }, index))
      ] })
    }
  );
};
...
export { ProfilePage };
//# sourceMappingURL=ProfilePage-5ix1J-t3.mjs.map
