...
import { e as errorsTrads } from './index-4iCJ7_08.mjs';
...
const COMMON_USER_SCHEMA = {
  ...
  password: yup.string().transform((value) => value === "" ? void 0 : value).nullable().min(8, {
...
//# sourceMappingURL=validation-Yg-jfoIk.mjs.map
