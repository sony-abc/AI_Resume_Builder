...
import { e as errorsTrads, l as useGuidedTour, b as Layouts } from './index-4iCJ7_08.mjs';
import { b as useTypedSelector, P as Page, a as useNotification, d as useTracking, k as useRBAC, f as useAPIErrorHandler } from './Theme-PrUuuGtN.mjs';
import { b as useGetAPITokenQuery, c as useCreateAPITokenMutation, d as useUpdateAPITokenMutation } from './apiTokens-YMUmHnrH.mjs';
import { b as adminApi, i as isBaseQueryError } from './admin-B6AW0Kov.mjs';
import { A as API_TOKEN_TYPE } from './constants-EoEtSd4i.mjs';
import { a as TokenName, b as TokenDescription, L as LifeSpanInput, c as TokenTypeSelect, F as FormHead, T as TokenBox } from './TokenTypeSelect-9u9d8fcv.mjs';
    ...
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
        ...
        /* @__PURE__ */ jsxs(Grid.Root, { gap: 5, children: [
          /* @__PURE__ */ jsx(Grid.Item, { col: 6, xs: 12, children: /* @__PURE__ */ jsx(
            TokenName,
            {
              error: errors["name"],
              value: values["name"],
    ...
    /* @__PURE__ */ jsx(Accordion.Content, { children: controllers?.map((controller) => {
      ...
      return /* @__PURE__ */ jsxs(Box, { children: [
        ...
        /* @__PURE__ */ jsx(Grid.Root, { gap: 4, padding: 4, children: controller?.actions && controller?.actions.map((action) => {
          return /* @__PURE__ */ jsx(Grid.Item, { col: 6, children: /* @__PURE__ */ jsxs(
            CheckboxWrapper,
            {
...
const Permissions = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsxs(Grid.Root, { gap: 0, shadow: "filterShadow", hasRadius: true, background: "neutral0", children: [
    /* @__PURE__ */ jsxs(Grid.Item, { col: 7, paddingTop: 6, paddingBottom: 6, paddingLeft: 7, paddingRight: 7, children: [
      /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
        /* @__PURE__ */ jsx(Typography, { variant: "delta", tag: "h2", children: formatMessage({
...
//# sourceMappingURL=EditViewPage-tTqJWPbg.mjs.map
