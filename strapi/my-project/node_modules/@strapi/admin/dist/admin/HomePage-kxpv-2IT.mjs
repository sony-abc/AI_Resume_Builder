...
import { LinkButton, Box, Flex, Typography, Button, Grid, Main, Link } from '@strapi/design-system';
import { ArrowRight, ExternalLink } from '@strapi/icons';
import { GitHub, Discord, Reddit, Strapi, X, Discourse, InformationSquare, CodeSquare, PlaySquare, FeatherSquare } from '@strapi/icons/symbols';
import { useIntl } from 'react-intl';
import { NavLink, useNavigate } from 'react-router-dom';
import { styled } from 'styled-components';
import { C as ContentBox } from './ContentBox-9LBDzws0.mjs';
import { d as useTracking, f as useAPIErrorHandler, a as useNotification, P as Page, n as useAppInfo } from './Theme-PrUuuGtN.mjs';
import { L as LAYOUT_DATA, N as Number, V as VerticalDivider, S as STATES } from './Ornaments-jAwgQeK0.mjs';
import { l as useGuidedTour, b as Layouts } from './index-4iCJ7_08.mjs';
import * as React from 'react';
import { b as adminApi } from './admin-B6AW0Kov.mjs';
  ...
  return /* @__PURE__ */ jsxs(Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxs(Main, { children: [
      ...
      /* @__PURE__ */ jsxs(Box, { padding: 10, children: [
        /* @__PURE__ */ jsx(Grid.Root, { children: /* @__PURE__ */ jsx(Grid.Item, { col: 8, s: 12, children: /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Box, { paddingLeft: 6, paddingBottom: 10, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "flex-start", gap: 5, children: [
          /* @__PURE__ */ jsx(Typography, { tag: "h1", variant: "alpha", children: hasAlreadyCreatedContentTypes ? formatMessage({
        ...
        /* @__PURE__ */ jsxs(Grid.Root, { gap: 6, children: [
          /* @__PURE__ */ jsx(Grid.Item, { col: 8, s: 12, children: showGuidedTour ? /* @__PURE__ */ jsx(GuidedTourHomepage, {}) : /* @__PURE__ */ jsx(ContentBlocks, {}) }),
          /* @__PURE__ */ jsx(Grid.Item, { col: 4, s: 12, children: /* @__PURE__ */ jsx(SocialLinks, {}) })
        ] })
      ] })
    ] })
  ] });
          ...
          Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs(Flex, { gap: 1, direction: "column", alignItems: "start", children: [
                /* @__PURE__ */ jsx(Typography, { fontWeight: "semiBold", variant: "pi", textColor: "neutral800", children: formatMessage({
                ...
                /* @__PURE__ */ jsx(Box, { src: cloudFlagsImage, position: "absolute", top: 0, right: 0, tag: "img" })
              ] })
            ]
          }
        )
      ...
      children: [
        /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 5, children: [
          /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 3, children: [
            /* @__PURE__ */ jsx(Typography, { variant: "delta", tag: "h2", id: "join-the-community", children: formatMessage({
        ...
        /* @__PURE__ */ jsx(GridGap, { children: socialLinksExtended.map(({ icon, link, name }) => {
          return /* @__PURE__ */ jsx(Grid.Item, { col: 6, s: 12, children: /* @__PURE__ */ jsx(LinkCustom, { size: "L", startIcon: icon, variant: "tertiary", href: link, isExternal: true, children: formatMessage(name) }) }, name.id);
        }) })
      ]
    }
  );
...
const SOCIAL_LINKS = [
  {
    ...
    icon: /* @__PURE__ */ jsx(StyledGithub, {}),
    alt: "github"
  },
  {
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-iOCLC8T5.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-kxpv-2IT.mjs.map
