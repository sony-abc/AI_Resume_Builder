...
const SSOProviders = ({ providers, displayAllProviders }) => {
  ...
  if (displayAllProviders) {
    return /* @__PURE__ */ jsx(Grid.Root, { gap: 4, children: providers.map((provider) => /* @__PURE__ */ jsx(Grid.Item, { col: 4, children: /* @__PURE__ */ jsx(SSOProviderButton, { provider }) }, provider.uid)) });
  }
  if (providers.length > 2 && !displayAllProviders) {
    return /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, children: [
      providers.slice(0, 2).map((provider) => /* @__PURE__ */ jsx(Grid.Item, { col: 4, children: /* @__PURE__ */ jsx(SSOProviderButton, { provider }) }, provider.uid)),
      /* @__PURE__ */ jsx(Grid.Item, { col: 4, children: /* @__PURE__ */ jsx(
        Tooltip,
        {
          ...
          children: /* @__PURE__ */ jsx(SSOButton, { as: Link, to: "/auth/providers", children: /* @__PURE__ */ jsx("span", { "aria-hidden": true, children: "•••" }) })
        }
      ) })
    ] });
  }
...
export { SSOProviders as S };
//# sourceMappingURL=SSOProviders-nMmBLr8g.mjs.map
