    ...
    designSystem.Tr,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "flex-end", onClick: (e) => e.stopPropagation(), children: icons.map((icon, i) => {
          if (icon) {
            return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: i === 0 ? 0 : 1, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.IconButton, { ...icon, borderWidth: 0 }) }, icon.label);
          }
          return null;
        }) }) })
      ]
...
//# sourceMappingURL=ListPage-qr-mWRUO.js.map
