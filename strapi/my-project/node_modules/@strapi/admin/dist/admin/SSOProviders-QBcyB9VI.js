...
const SSOProviders = ({ providers, displayAllProviders }) => {
  ...
  if (displayAllProviders) {
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Root, { gap: 4, children: providers.map((provider) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 4, children: /* @__PURE__ */ jsxRuntime.jsx(SSOProviderButton, { provider }) }, provider.uid)) });
  }
  if (providers.length > 2 && !displayAllProviders) {
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { gap: 4, children: [
      providers.slice(0, 2).map((provider) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 4, children: /* @__PURE__ */ jsxRuntime.jsx(SSOProviderButton, { provider }) }, provider.uid)),
...
const SSOProvidersWrapper = styledComponents.styled(designSystem.Flex)`
...
const SSOButton = styledComponents.styled.a`
  width: 13.6rem;
  display: flex;
...
//# sourceMappingURL=SSOProviders-QBcyB9VI.js.map
