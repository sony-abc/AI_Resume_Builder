...
import { o as useQueryParams, p as useFetchClient, b as Layouts, S as SearchInput, C as ConfirmDialog } from './index-4iCJ7_08.mjs';
import { b as useTypedSelector, P as Page, f as useAPIErrorHandler, a as useNotification, k as useRBAC } from './Theme-PrUuuGtN.mjs';
import { u as useAdminRoles } from './useAdminRoles-ZBjAOdVi.mjs';
import { s as selectAdminPermissions } from './selectors-ZpHhvPK4.mjs';
import { c as isFetchError } from './admin-B6AW0Kov.mjs';
    ...
    Tr,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Flex, { justifyContent: "flex-end", onClick: (e) => e.stopPropagation(), children: icons.map((icon, i) => {
          if (icon) {
            return /* @__PURE__ */ jsx(Box, { paddingLeft: i === 0 ? 0 : 1, children: /* @__PURE__ */ jsx(IconButton, { ...icon, borderWidth: 0 }) }, icon.label);
          }
          return null;
        }) }) })
      ]
...
//# sourceMappingURL=ListPage-uSjUZ61P.mjs.map
