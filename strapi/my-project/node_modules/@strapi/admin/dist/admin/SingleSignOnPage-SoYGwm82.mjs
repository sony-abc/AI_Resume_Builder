...
import { e as errorsTrads, b as Layouts, F as Form, M as MemoizedInputRenderer, u as useField } from './index-4iCJ7_08.mjs';
import { b as useTypedSelector, P as Page, a as useNotification, f as useAPIErrorHandler, i as useGetProviderOptionsQuery, j as useUpdateProviderOptionsMutation, k as useRBAC } from './Theme-PrUuuGtN.mjs';
import { u as useAdminRoles } from './useAdminRoles-ZBjAOdVi.mjs';
          ...
          /* @__PURE__ */ jsx(Layouts.Content, { children: isSubmitting || isLoadingData ? /* @__PURE__ */ jsx(Page.Loading, {}) : /* @__PURE__ */ jsxs(
            Flex,
            {
              ...
              children: [
                ...
                ].map(({ size, ...field }) => /* @__PURE__ */ jsx(Grid.Item, { col: size, children: /* @__PURE__ */ jsx(FormInputRenderer, { ...field }) }, field.name)) })
              ]
            }
          ) })
        ] })
...
//# sourceMappingURL=SingleSignOnPage-SoYGwm82.mjs.map
