...
import { r as SETTINGS_LINKS_CE, b as Layouts } from './index-4iCJ7_08.mjs';
import { u as useAuth, n as useAppInfo, o as useStrapiApp, d as useTracking, P as Page } from './Theme-PrUuuGtN.mjs';
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import('./index-4iCJ7_08.mjs').then(n => n.K)).SETTINGS_LINKS_EE(),
    {
...
export { Layout };
//# sourceMappingURL=Layout-Z093DFKa.mjs.map
