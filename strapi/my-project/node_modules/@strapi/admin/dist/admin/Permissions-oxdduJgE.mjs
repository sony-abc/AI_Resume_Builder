...
import { v as isObject$1, w as capitalise } from './Theme-PrUuuGtN.mjs';
...
const ConditionsButtonImpl = React.forwardRef(
  ({ onClick, className, hasConditions = false, variant = "tertiary" }, ref) => {
    const { formatMessage } = useIntl();
    return /* @__PURE__ */ jsx(ButtonContainer, { $hasConditions: hasConditions, className, children: /* @__PURE__ */ jsx(Button, { variant, startIcon: /* @__PURE__ */ jsx(Cog, {}), onClick, ref, children: formatMessage({
      id: "global.settings",
...
const ActionRow = ({
  ...
  return /* @__PURE__ */ jsxs(Flex, { tag: "li", background: isGrey ? "neutral100" : "neutral0", paddingBottom: 3, paddingTop: 3, children: [
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Box, { children: [
    ...
    /* @__PURE__ */ jsxs(Flex, { paddingTop: 6, paddingBottom: 6, children: [
      /* @__PURE__ */ jsx(Grid.Root, { gap: 2, style: { flex: 1 }, children: formattedActions.map(({ checkboxName, value, action, displayName, hasConditions }) => {
        return /* @__PURE__ */ jsx(Grid.Item, { col: 3, children: /* @__PURE__ */ jsx(CheckboxWrapper, { $disabled: isFormDisabled, $hasConditions: hasConditions, children: /* @__PURE__ */ jsx(
          Checkbox,
          {
            name: checkboxName,
            disabled: isFormDisabled,
...
//# sourceMappingURL=Permissions-oxdduJgE.mjs.map
