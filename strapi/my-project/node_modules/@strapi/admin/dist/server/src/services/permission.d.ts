...
declare const actionProvider: {
    ...
    register(actionAttributes: Omit<Omit<import("../domain/action").Action, "actionId">, "options"> & Partial<Pick<Omit<import("../domain/action").Action, "actionId">, "options">> & {
        uid: string;
    }): Promise<import("@strapi/utils/dist/provider-factory").Provider>;
    registerMany(actionsAttributes: (Omit<Omit<import("../domain/action").Action, "actionId">, "options"> & Partial<Pick<Omit<import("../domain/action").Action, "actionId">, "options">> & {
        uid: string;
    })[]): Promise<any>;
