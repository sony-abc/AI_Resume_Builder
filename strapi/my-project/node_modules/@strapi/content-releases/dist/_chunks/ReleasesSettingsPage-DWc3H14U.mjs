...
import { a as useGetReleaseSettingsQuery, l as useUpdateReleaseSettingsMutation, g as getTimezones } from "./index-CPq3qdIv.mjs";
...
const ReleasesSettingsPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsx(Page.Main, { "aria-busy": isLoadingSettings, tabIndex: -1, children: /* @__PURE__ */ jsx(
      Form,
      {
        method: "PUT",
        initialValues: {
...
//# sourceMappingURL=ReleasesSettingsPage-DWc3H14U.mjs.map
