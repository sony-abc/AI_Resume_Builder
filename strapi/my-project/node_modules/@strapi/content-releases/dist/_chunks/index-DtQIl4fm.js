  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => Promise.resolve().then(() => require("./App-DdxsZcmK.js")).then((mod) => ({ default: mod.App })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await Promise.resolve().then(() => require("./ReleasesSettingsPage-CwsExK2M.js"));
...
//# sourceMappingURL=index-DtQIl4fm.js.map
