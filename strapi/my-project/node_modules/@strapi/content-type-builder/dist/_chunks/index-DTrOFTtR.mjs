...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./index-DuI_0sF6.mjs").then((n) => n.i),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
//# sourceMappingURL=index-DTrOFTtR.mjs.map
