...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./index-BLF1AIxt.js")).then((n) => n.index),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
//# sourceMappingURL=index-DgZgByqn.js.map
