...
const index = {
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/ca.json": () => import("./ca-B2_I-q1t.mjs"), "./translations/de.json": () => import("./de-A7mEKx6c.mjs"), "./translations/dk.json": () => import("./dk-BPfkJb9q.mjs"), "./translations/en.json": () => import("./en-oDx2Gnre.mjs"), "./translations/es.json": () => import("./es-CuWi2pOn.mjs"), "./translations/fr.json": () => import("./fr-BN6ndmWf.mjs"), "./translations/he.json": () => import("./he-C9ZOXBB-.mjs"), "./translations/it.json": () => import("./it-B7rmoZNx.mjs"), "./translations/ja.json": () => import("./ja-DlaJTi_3.mjs"), "./translations/ko.json": () => import("./ko-vJl9kPpn.mjs"), "./translations/ms.json": () => import("./ms-CqwG8v8l.mjs"), "./translations/pl.json": () => import("./pl-Cj8jChOO.mjs"), "./translations/pt-BR.json": () => import("./pt-BR-B4LJHJIp.mjs"), "./translations/pt.json": () => import("./pt-CNOOM_7x.mjs"), "./translations/ru.json": () => import("./ru-DqglvSUC.mjs"), "./translations/sk.json": () => import("./sk-Dgpb3lnz.mjs"), "./translations/th.json": () => import("./th-DRfzuiFf.mjs"), "./translations/tr.json": () => import("./tr--GzWXE_A.mjs"), "./translations/uk.json": () => import("./uk-DVMT2Piq.mjs"), "./translations/zh-Hans.json": () => import("./zh-Hans-Cpmhg8uH.mjs"), "./translations/zh.json": () => import("./zh-HOnih0is.mjs") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
