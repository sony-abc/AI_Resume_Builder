...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./index-C3CfaRKc.js")),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      to: "media-library",
      Component: () => Promise.resolve().then(() => require("./index-b9YY-1Cn.js")),
...
//# sourceMappingURL=index-B0H-C5mc.js.map
