...
import { u as useTracking, L as Layouts } from "./index-4iCJ7_08-BdVTyJ7l.mjs";
...
import { g as getTrad, P as PERMISSIONS } from "./index-B7tUaGva.mjs";
          ...
          return /* @__PURE__ */ jsxs(Form, { children: [
            /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsx(Flex, { direction: "column", alignItems: "stretch", gap: 1, children: /* @__PURE__ */ jsx(Grid.Root, { gap: 5, children: layout.form.map((row) => {
              return row.map((input) => {
                return /* @__PURE__ */ jsx(Grid.Item, { col: input.size, xs: 12, children: /* @__PURE__ */ jsx(
                  Input,
                  {
                    ...input,
...
//# sourceMappingURL=index-D2uZMaoO.mjs.map
