...
const index4iCJ7_08 = require("./index-4iCJ7_08-NB2384Tl.js");
...
const index = require("./index-CGpGnIc7.js");
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs(formik.Form, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Root, { gap: 5, children: layout.form.map((row) => {
              return row.map((input) => {
                return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: input.size, xs: 12, children: /* @__PURE__ */ jsxRuntime.jsx(
                  Input,
                  {
                    ...input,
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = index4iCJ7_08.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(index4iCJ7_08.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index4iCJ7_08.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-2NkhLDmW.js.map
