...
const AssigneeSelect = () => {
  ...
  } = strapiAdmin.useRBAC(permissions.settings?.users);
  const [{ query }] = strapiAdmin.useQueryParams();
  const params = React__namespace.useMemo(() => buildValidParams(query), [query]);
  const { data, isLoading, isError } = strapiAdmin.useAdminUsers(void 0, {
...
const Root = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Content, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, paddingLeft: 7, position: "relative", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "start", direction: "column", gap: 2, width: "60%", children: [
      children,
      /* @__PURE__ */ jsxRuntime.jsx(CallToActions, {})
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "end", height: "100%", width: "40%", children: [
      /* @__PURE__ */ jsxRuntime.jsx(BalloonImage, { src: balloonImageSrc, "aria-hidden": true, alt: "", loading: "lazy" }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { display: "flex", position: "absolute", right: 0, top: 0, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Close, { children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.SingleSelect,
            {
              ...
              customizeContent: () => {
                return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { tag: "span", justifyContent: "space-between", alignItems: "center", width: "100%", children: [
...
const Panel = () => {
  ...
  return {
    ...
    content: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 2, alignItems: "stretch", width: "100%", children: [
...
const AssigneeColumn = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: user ? getDisplayName(user) : "-" });
};
const REVIEW_WORKFLOW_COLUMNS = [
  {
    ...
    cellFormatter: (props) => /* @__PURE__ */ jsxRuntime.jsx(StageColumn, { ...props })
  },
  {
    name: ASSIGNEE_ATTRIBUTE_NAME,
    attribute: {
    ...
    cellFormatter: (props) => /* @__PURE__ */ jsxRuntime.jsx(AssigneeColumn, { ...props })
  }
];
