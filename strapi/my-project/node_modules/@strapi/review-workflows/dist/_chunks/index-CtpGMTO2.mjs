...
const Title = ({ children }) => {
  return /* @__PURE__ */ jsx(Modal.Title, { variant: "alpha", children });
};
const Body = ({ children }) => {
  return /* @__PURE__ */ jsx(Typography, { variant: "omega", children });
};
const CallToActions = () => {
  const { formatMessage } = useIntl();
  return /* @__PURE__ */ jsxs(Flex, { gap: 2, paddingTop: 4, children: [
    /* @__PURE__ */ jsx(LinkButton, { variant: "default", isExternal: true, href: CTA_LEARN_MORE_HREF, children: formatMessage({
      id: "Settings.review-workflows.limit.cta.learn",
      defaultMessage: "Learn more"
    }) }),
    /* @__PURE__ */ jsx(LinkButton, { variant: "tertiary", isExternal: true, href: CTA_SALES_HREF, children: formatMessage({
...
const Root = ({
  ...
  const { formatMessage } = useIntl();
  return /* @__PURE__ */ jsx(Modal.Root, { open, onOpenChange, children: /* @__PURE__ */ jsx(Modal.Content, { children: /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsxs(Flex, { gap: 2, paddingLeft: 7, position: "relative", children: [
    /* @__PURE__ */ jsxs(Flex, { alignItems: "start", direction: "column", gap: 2, width: "60%", children: [
      children,
      /* @__PURE__ */ jsx(CallToActions, {})
    ] }),
    /* @__PURE__ */ jsxs(Flex, { justifyContent: "end", height: "100%", width: "40%", children: [
      /* @__PURE__ */ jsx(BalloonImage, { src: balloonImageSrc, "aria-hidden": true, alt: "", loading: "lazy" }),
      /* @__PURE__ */ jsx(Box, { display: "flex", position: "absolute", right: 0, top: 0, children: /* @__PURE__ */ jsx(Modal.Close, { children: /* @__PURE__ */ jsx(
        IconButton,
        {
          withTooltip: false,
          label: formatMessage({
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(
            SingleSelect,
            {
              ...
              customizeContent: () => {
                return /* @__PURE__ */ jsxs(Flex, { tag: "span", justifyContent: "space-between", alignItems: "center", width: "100%", children: [
...
const Panel = () => {
  ...
  return {
    ...
    content: /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, alignItems: "stretch", width: "100%", children: [
...
const AssigneeColumn = (props) => {
  ...
  return /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: user ? getDisplayName(user) : "-" });
};
const REVIEW_WORKFLOW_COLUMNS = [
  {
    ...
    cellFormatter: (props) => /* @__PURE__ */ jsx(StageColumn, { ...props })
  },
  {
    name: ASSIGNEE_ATTRIBUTE_NAME,
    attribute: {
    ...
    cellFormatter: (props) => /* @__PURE__ */ jsx(AssigneeColumn, { ...props })
  }
];
...
export {
  AVAILABLE_COLORS as A,
  CHARGEBEE_WORKFLOW_ENTITLEMENT_NAME as C,
  LimitsModal as L,
  useTypedSelector as a,
  CHARGEBEE_STAGES_PER_WORKFLOW_ENTITLEMENT_NAME as b,
