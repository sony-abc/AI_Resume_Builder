...
const ProtectedListPage = React.lazy(
  () => Promise.resolve().then(() => require("./index-CI4KFjfU.js")).then((mod) => ({ default: mod.ProtectedListPage }))
);
const ProtectedEditPage = React.lazy(
  () => Promise.resolve().then(() => require("./_id-C-SYBc57.js")).then((mod) => ({ default: mod.ProtectedEditPage }))
);
const routes = [
  {
    path: "/",
...
//# sourceMappingURL=router-Co81pRA9.js.map
