...
const handleResponsiveValues = (property, value, theme) => {
  ...
  if (typeof value === "object") {
    const transformedArray = Array.isArray(value) ? value : [value?.desktop, value?.tablet, value?.mobile];
...
const Item$5 = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(AccordionItem, { $size: size, ref: forwardedRef, ...props });
});
  ...
  ({ caretPosition = "left", description, icon: Icon, children, ...restProps }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(AccordionTrigger, { $caretPosition: caretPosition, $size: size, ref: forwardedRef, ...restProps, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(Flex, { tag: "span", gap: 2, children: [
        Icon ? /* @__PURE__ */ jsxRuntime.jsx(IconBox$4, { children: /* @__PURE__ */ jsxRuntime.jsx(Icon, {}) }) : null,
        /* @__PURE__ */ jsxRuntime.jsxs(Flex, { alignItems: "flex-start", direction: "column", tag: "span", ref: forwardedRef, children: [
          ...
          description && size === "M" ? /* @__PURE__ */ jsxRuntime.jsx(Typography, { children: description }) : null
        ] })
      ] }),
...
const BaseButtonWrapper = styledComponents.styled(Flex)`
  &[aria-disabled='true'] {
    pointer-events: none;
  }
...
const Breadcrumbs = ({ label, children, ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Box, { "aria-label": label, tag: "nav", ...props, children: /* @__PURE__ */ jsxRuntime.jsx(AlignedList, { tag: "ol", children: React__namespace.Children.map(childrenArray, (child, index) => {
...
const Crumb = ({ children, isCurrent = false, ...props }) => /* @__PURE__ */ jsxRuntime.jsx(Box, { paddingLeft: 2, paddingRight: 2, paddingTop: 1, paddingBottom: 1, children: /* @__PURE__ */ jsxRuntime.jsx(
  Typography,
  {
    variant: "pi",
...
const StyledLink = styledComponents.styled(BaseLink)`
...
`;
const CrumbLink = ({ children, ...props }) => /* @__PURE__ */ jsxRuntime.jsx(StyledLink, { ...props, children });
...
const VARIANTS$1 = [DEFAULT, TERTIARY, SECONDARY, DANGER, SUCCESS, GHOST, ...LIGHT_VARIANTS];
...
const getVariantColorName = (variant2) => {
  ...
  if (variant2 === DEFAULT || variant2 === SECONDARY || VARIANTS$1.every((vari) => vari !== variant2)) {
    return "primary";
  }
  return `${variant2}`;
};
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      ButtonWrapper,
      {
        ...
        ...props,
        children: [
          (startIcon || loading) && /* @__PURE__ */ jsxRuntime.jsx(Box, { "aria-hidden": true, children: loading ? /* @__PURE__ */ jsxRuntime.jsx(LoaderAnimated, {}) : startIcon }),
          /* @__PURE__ */ jsxRuntime.jsx(Typography, { variant: size === "S" ? "pi" : void 0, fontWeight: "bold", children }),
          endIcon && /* @__PURE__ */ jsxRuntime.jsx(Flex, { "aria-hidden": true, children: endIcon })
        ]
      }
    );
  }
...
`;
const ButtonWrapper = styledComponents.styled(BaseButton)`
...
const Link = forwardRef(
  ({ children, href, disabled = false, startIcon, endIcon, isExternal = false, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntime.jsxs(LinkWrapper$2, { ref, href, disabled, isExternal, ...props, children: [
      startIcon,
...
const LinkWrapper$2 = styledComponents.styled(BaseLink)`
  display: inline-flex;
  align-items: center;
  text-decoration: none;
...
const MenuTrigger = React__namespace.forwardRef(
  ({ size, endIcon = /* @__PURE__ */ jsxRuntime.jsx(icons.CaretDown, { width: "0.6rem", height: "0.4rem", "aria-hidden": true }), ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntime.jsx(DropdownMenu__namespace.Trigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(
      Button,
      {
        ref,
        type: "button",
...
const MenuContent = React__namespace.forwardRef(
  ({ children, intersectionId, popoverPlacement = "bottom-start", ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(DropdownMenu__namespace.Portal, { children: /* @__PURE__ */ jsxRuntime.jsx(DropdownMenu__namespace.Content, { align, side, loop: true, asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
      Viewport$2,
      {
        ref,
        direction: "column",
...
const SimpleMenu = ({ children, onOpen, onClose, popoverPlacement, onReachEnd, ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Root$7, { onOpenChange: handleOpenChange, children: [
    /* @__PURE__ */ jsxRuntime.jsx(Trigger$6, { ...props, children: props.label }),
    /* @__PURE__ */ jsxRuntime.jsx(Content$6, { intersectionId, popoverPlacement, children })
  ] });
};
...
`;
const CrumbSimpleMenu = ({ children, ...props }) => /* @__PURE__ */ jsxRuntime.jsx(StyledButton, { endIcon: null, size: "S", ...props, children });
...
const CardActionImpl = ({ position, ...restProps }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(CardAction, { $position: position, ...restProps, direction: "row", gap: 2 });
};
...
const CheckboxEl = React__namespace.forwardRef(
  ({ defaultChecked, checked: checkedProp, onCheckedChange, ...props }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(CheckboxRoot, { ref: composedRefs, checked, onCheckedChange: setChecked, ...props, children: /* @__PURE__ */ jsxRuntime.jsxs(Checkbox__namespace.Indicator, { children: [
      checked === true ? /* @__PURE__ */ jsxRuntime.jsx(CheckIcon, { width: "1rem", fill: "neutral0" }) : null,
      checked === "indeterminate" ? /* @__PURE__ */ jsxRuntime.jsx(Box, { height: "2px", width: "1rem", background: "neutral0", borderRadius: "1px" }) : null
    ] }) });
  }
);
...
const CardCheckbox = (props) => {
  const { id } = useCard();
  return /* @__PURE__ */ jsxRuntime.jsx(CardActionImpl, { position: "start", children: /* @__PURE__ */ jsxRuntime.jsx(CheckboxImpl, { "aria-labelledby": `${id}-title`, ...props }) });
};
        ...
        CarouselGrid,
        {
          ...
          children: [
            childrenArray && childrenArray.length > 1 && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(CarouselAction, { tag: "button", onClick: onPrevious, $area: "startAction", ref: prevActionRef, type: "button", children: /* @__PURE__ */ jsxRuntime.jsx(AccessibleIcon, { label: previousLabel, children: /* @__PURE__ */ jsxRuntime.jsx(icons.ChevronLeft, { width: "6px", height: "10px", fill: "neutral600" }) }) }),
              /* @__PURE__ */ jsxRuntime.jsx(CarouselAction, { tag: "button", onClick: onNext, $area: "endAction", ref: nextActionRef, type: "button", children: /* @__PURE__ */ jsxRuntime.jsx(AccessibleIcon, { label: nextLabel, children: /* @__PURE__ */ jsxRuntime.jsx(icons.ChevronRight, { width: "6px", height: "10px", fill: "neutral600" }) }) })
            ] }),
...
(function(module2, exports2) {
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      var Array2 = context.Array, Date2 = context.Date, Error2 = context.Error, Function2 = context.Function, Math = context.Math, Object2 = context.Object, RegExp2 = context.RegExp, String2 = context.String, TypeError = context.TypeError;
...
const extendTheme = (theme, overrides) => {
  ...
  function customizer(objValue, srcValue) {
    ...
    if (isObject(objValue) && isObject(srcValue)) {
      return lodashExports.merge(objValue, srcValue);
    }
    return void 0;
  }
  const masterTheme = lodashExports.cloneDeep(theme ?? {});
  const masterOverrides = lodashExports.cloneDeep(overrides ?? {});
  lodashExports.assignWith(masterTheme, masterOverrides, customizer);
  return masterTheme;
};
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(Trigger$5, { $hasError: hasError, $size: size, className, children: [
            /* @__PURE__ */ jsxRuntime.jsxs(Flex, { flex: "1", tag: "span", gap: 3, children: [
              startIcon ? /* @__PURE__ */ jsxRuntime.jsx(Box, { flex: "0 0 1.6rem", tag: "span", "aria-hidden": true, children: startIcon }) : null,
              /* @__PURE__ */ jsxRuntime.jsx(
                TextInput$1,
                {
                  placeholder,
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(Flex, { tag: "span", gap: 3, children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(DownIcon$1, { children: /* @__PURE__ */ jsxRuntime.jsx(icons.CaretDown, {}) })
            ] })
          ] }),
...
const Header$1 = React__namespace.forwardRef(({ children, ...restProps }, forwardedRef) => {
  return /* @__PURE__ */ jsxRuntime.jsx(AlertDialog__namespace.Title, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(
    Title$1,
    {
      tag: "h2",
      ref: forwardedRef,
...
const Root$3 = forwardRef((props, forwardedRef) => {
  const { gap = 0, gridCols = 12, ...rest } = props;
  return /* @__PURE__ */ jsxRuntime.jsx(Wrapper$1, { ref: forwardedRef, $gap: gap, $gridCols: gridCols, ...rest });
});
...
const ItemImpl = forwardRef(
  ({ col, s, xs, ...props }, forwardedRef) => /* @__PURE__ */ jsxRuntime.jsx(Item$1, { ref: forwardedRef, $col: col, $s: s, $xs: xs, ...props })
);
const Item$1 = styledComponents.styled(Box)`
...
const IconButtonWrapper = styledComponents.styled(BaseButton)`
...
const LinkButton = forwardRef(
  ({ variant: variant2 = "default", startIcon, endIcon, disabled = false, children, size = "S", ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      LinkWrapper$1,
      {
        ...
        ...props,
        children: [
          startIcon && /* @__PURE__ */ jsxRuntime.jsx(Flex, { "aria-hidden": true, children: startIcon }),
          /* @__PURE__ */ jsxRuntime.jsx(Typography, { variant: size === "S" ? "pi" : void 0, fontWeight: "bold", children }),
          endIcon && /* @__PURE__ */ jsxRuntime.jsx(Flex, { "aria-hidden": true, children: endIcon })
        ]
      }
...
const LinkWrapper$1 = styledComponents.styled(BaseLink)`
  gap: ${({ theme }) => theme.spaces[2]};
...
`;
const Root$2 = Dialog__namespace.Root;
...
const Content$2 = React__namespace.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(Dialog__namespace.Portal, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(Overlay, {}),
    /* @__PURE__ */ jsxRuntime.jsx(ContentImpl, { ref: forwardedRef, ...props })
  ] });
});
...
const LinkWrapper = styledComponents.styled(BaseLink)`
...
const Root$1 = Popover__namespace.Root;
...
`;
const ScrollAreaImpl = ({ children, intersectionId, onReachEnd, ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(PopoverScrollArea, { ref: popoverRef, ...props, children: [
    children,
...
`;
const Item = React__namespace.forwardRef(({ children, id: idProp, ...restProps }, forwardedRef) => {
...
const RawTd = ({ coords = { col: 0, row: 0 }, tag = "td", ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Box, { role: "gridcell", tag, ref: tdRef, onKeyDown: handleKeyDown, ...props });
};
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(SearchbarWrapper, { children: /* @__PURE__ */ jsxRuntime.jsxs(Root$6, { name, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        SearchbarInput,
        {
          ...
          endAction: isCompleting ? /* @__PURE__ */ jsxRuntime.jsx(Action$1, { label: clearLabel, onClick: handleClear, children: /* @__PURE__ */ jsxRuntime.jsx(CloseIcon, {}) }) : void 0,
          ...props
        }
      )
    ] }) });
...
const TagWrapper = styledComponents.styled(Flex)`
  & > svg {
    height: 0.8rem;
    width: 0.8rem;
  }
  ...
  ({
    ...
    const renderTags = (arg) => {
      if (arg && typeof arg === "object" && arg.value) {
        return /* @__PURE__ */ jsxRuntime.jsx(Tag, { tabIndex: -1, disabled, icon: /* @__PURE__ */ jsxRuntime.jsx(icons.Cross, {}), onClick: handleTagClick(arg.value), children: arg.textValue }, arg.value);
      }
      return null;
    };
...
`;
const Status = ({ variant: variant2 = "primary", showBullet = true, size = "M", children, ...props }) => {
  const backgroundColor = `${variant2}100`;
  const borderColor = `${variant2}200`;
  const bulletColor = `${variant2}600`;
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Box,
    {
      ...
      paddingRight: paddingX,
      ...props,
      children: showBullet ? /* @__PURE__ */ jsxRuntime.jsxs(Flex, { gap: 3, children: [
        /* @__PURE__ */ jsxRuntime.jsx(Box, { background: bulletColor, width: "0.6rem", height: "0.6rem", borderRadius: "50%" }),
        children
      ] }) : children
    }
  );
...
const SubNavHeader = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Flex, { direction: "column", alignItems: "flex-start", paddingLeft: 6, paddingTop: 6, paddingBottom: 2, paddingRight: 4, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(Flex, { justifyContent: "space-between", alignItems: "flex-start", children: [
...
const CustomBullet = styledComponents.styled.span`
  ...
  border-radius: 50%;
`;
const SubNavLinkWrapper = styledComponents.styled(BaseLink)`
  display: flex;
  align-items: center;
  justify-content: space-between;
  text-decoration: none;
...
const Root = React__namespace.forwardRef(
...
const TabsTrigger = styledComponents.styled(Tabs__namespace.Trigger)`
  ...
  @media (prefers-reduced-motion: no-preference) {
    transition: ${(props) => `${props.theme.transitions.color}, ${props.theme.transitions.backgroundColor}, box-shadow ${props.theme.motion.timings["120"]} ${props.theme.motion.easings.easeOutQuad}`};
  }
...
const Table = ({ footer, ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(TableContainer, { shadow: "tableShadow", hasRadius: true, background: "neutral0", children: [
    /* @__PURE__ */ jsxRuntime.jsx(TableBox, { $overflowing: overflowing, position: "relative", children: /* @__PURE__ */ jsxRuntime.jsx(ScrollContainer, { ref: tableRef, onScroll: handleScroll, paddingLeft: 6, paddingRight: 6, children: /* @__PURE__ */ jsxRuntime.jsx(TableWrapper, { ...props }) }) }),
    footer
  ] });
};
...
const Th = ({ children, action, ...props }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(CellWrapper, { as: RawTh, ...props, children: /* @__PURE__ */ jsxRuntime.jsxs(Flex, { children: [
    children,
    action
  ] }) });
};
const Td = ({ children, ...props }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(CellWrapper, { ...props, children });
};
...
const TextButtonWrapper = styledComponents.styled(Flex)`
  ...
  ${focus}
`;
const TextButton = React__namespace.forwardRef(
  ({ children, startIcon, endIcon, onClick, disabled = false, loading = false, ...props }, ref) => {
    const handleClick = onClick && !disabled ? onClick : void 0;
    const isDisabled = disabled || loading;
    return /* @__PURE__ */ jsxRuntime.jsxs(
      TextButtonWrapper,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(Typography, { variant: "pi", textColor: isDisabled ? "neutral600" : "primary600", children }),
          endIcon
        ]
      }
    );
...
const Textarea = React__namespace.forwardRef(
  ({ disabled, hasError: hasErrorProp, id: idProp, name: nameProp, required: requiredProp, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(Wrapper, { borderColor: hasError ? "danger600" : "neutral200", $hasError: hasError, hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsx(
      TextareaElement,
      {
