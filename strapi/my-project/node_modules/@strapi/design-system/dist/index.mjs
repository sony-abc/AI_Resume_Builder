...
import { useCallbackRef, Combobox as Combobox$1, Select, composeEventHandlers, usePrev } from "@strapi/ui-primitives";
...
import { CaretDown, Cross, CheckCircle, WarningCircle, Information, Loader as Loader$1, ExternalLink, ChevronRight, ChevronLeft, Calendar, Clock, Search } from "@strapi/icons";
...
const Item$5 = React.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx(AccordionItem, { $size: size, ref: forwardedRef, ...props });
});
  ...
  ({ caretPosition = "left", description, icon: Icon, children, ...restProps }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs(AccordionTrigger, { $caretPosition: caretPosition, $size: size, ref: forwardedRef, ...restProps, children: [
      ...
      /* @__PURE__ */ jsxs(Flex, { tag: "span", gap: 2, children: [
        Icon ? /* @__PURE__ */ jsx(IconBox$4, { children: /* @__PURE__ */ jsx(Icon, {}) }) : null,
        /* @__PURE__ */ jsxs(Flex, { alignItems: "flex-start", direction: "column", tag: "span", ref: forwardedRef, children: [
          ...
          description && size === "M" ? /* @__PURE__ */ jsx(Typography, { children: description }) : null
        ] })
      ] }),
...
const Breadcrumbs = ({ label, children, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(Box, { "aria-label": label, tag: "nav", ...props, children: /* @__PURE__ */ jsx(AlignedList, { tag: "ol", children: React.Children.map(childrenArray, (child, index) => {
...
const Crumb = ({ children, isCurrent = false, ...props }) => /* @__PURE__ */ jsx(Box, { paddingLeft: 2, paddingRight: 2, paddingTop: 1, paddingBottom: 1, children: /* @__PURE__ */ jsx(
  Typography,
  {
    variant: "pi",
...
`;
const CrumbLink = ({ children, ...props }) => /* @__PURE__ */ jsx(StyledLink, { ...props, children });
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      ButtonWrapper,
      {
        ...
        ...props,
        children: [
          (startIcon || loading) && /* @__PURE__ */ jsx(Box, { "aria-hidden": true, children: loading ? /* @__PURE__ */ jsx(LoaderAnimated, {}) : startIcon }),
          /* @__PURE__ */ jsx(Typography, { variant: size === "S" ? "pi" : void 0, fontWeight: "bold", children }),
          endIcon && /* @__PURE__ */ jsx(Flex, { "aria-hidden": true, children: endIcon })
        ]
      }
    );
  }
...
const Link = forwardRef(
  ({ children, href, disabled = false, startIcon, endIcon, isExternal = false, ...props }, ref) => {
    return /* @__PURE__ */ jsxs(LinkWrapper$2, { ref, href, disabled, isExternal, ...props, children: [
      startIcon,
...
const LinkWrapper$2 = styled(BaseLink)`
  display: inline-flex;
  align-items: center;
  text-decoration: none;
...
const MenuTrigger = React.forwardRef(
  ({ size, endIcon = /* @__PURE__ */ jsx(CaretDown, { width: "0.6rem", height: "0.4rem", "aria-hidden": true }), ...props }, ref) => {
    return /* @__PURE__ */ jsx(DropdownMenu.Trigger, { asChild: true, children: /* @__PURE__ */ jsx(
      Button,
      {
        ref,
        type: "button",
...
const MenuContent = React.forwardRef(
  ({ children, intersectionId, popoverPlacement = "bottom-start", ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx(DropdownMenu.Portal, { children: /* @__PURE__ */ jsx(DropdownMenu.Content, { align, side, loop: true, asChild: true, children: /* @__PURE__ */ jsxs(
      Viewport$2,
      {
        ref,
        direction: "column",
...
const SimpleMenu = ({ children, onOpen, onClose, popoverPlacement, onReachEnd, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs(Root$7, { onOpenChange: handleOpenChange, children: [
    /* @__PURE__ */ jsx(Trigger$6, { ...props, children: props.label }),
    /* @__PURE__ */ jsx(Content$6, { intersectionId, popoverPlacement, children })
  ] });
};
...
`;
const CrumbSimpleMenu = ({ children, ...props }) => /* @__PURE__ */ jsx(StyledButton, { endIcon: null, size: "S", ...props, children });
...
const CardActionImpl = ({ position, ...restProps }) => {
  return /* @__PURE__ */ jsx(CardAction, { $position: position, ...restProps, direction: "row", gap: 2 });
};
...
const CheckboxEl = React.forwardRef(
  ({ defaultChecked, checked: checkedProp, onCheckedChange, ...props }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(CheckboxRoot, { ref: composedRefs, checked, onCheckedChange: setChecked, ...props, children: /* @__PURE__ */ jsxs(Checkbox.Indicator, { children: [
      checked === true ? /* @__PURE__ */ jsx(CheckIcon, { width: "1rem", fill: "neutral0" }) : null,
      checked === "indeterminate" ? /* @__PURE__ */ jsx(Box, { height: "2px", width: "1rem", background: "neutral0", borderRadius: "1px" }) : null
    ] }) });
  }
);
...
const CardCheckbox = (props) => {
  const { id } = useCard();
  return /* @__PURE__ */ jsx(CardActionImpl, { position: "start", children: /* @__PURE__ */ jsx(CheckboxImpl, { "aria-labelledby": `${id}-title`, ...props }) });
};
        ...
        CarouselGrid,
        {
          ...
          children: [
            childrenArray && childrenArray.length > 1 && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(CarouselAction, { tag: "button", onClick: onPrevious, $area: "startAction", ref: prevActionRef, type: "button", children: /* @__PURE__ */ jsx(AccessibleIcon, { label: previousLabel, children: /* @__PURE__ */ jsx(ChevronLeft, { width: "6px", height: "10px", fill: "neutral600" }) }) }),
              /* @__PURE__ */ jsx(CarouselAction, { tag: "button", onClick: onNext, $area: "endAction", ref: nextActionRef, type: "button", children: /* @__PURE__ */ jsx(AccessibleIcon, { label: nextLabel, children: /* @__PURE__ */ jsx(ChevronRight, { width: "6px", height: "10px", fill: "neutral600" }) }) })
            ] }),
        ...
        children: [
          /* @__PURE__ */ jsxs(Trigger$5, { $hasError: hasError, $size: size, className, children: [
            /* @__PURE__ */ jsxs(Flex, { flex: "1", tag: "span", gap: 3, children: [
              startIcon ? /* @__PURE__ */ jsx(Box, { flex: "0 0 1.6rem", tag: "span", "aria-hidden": true, children: startIcon }) : null,
              /* @__PURE__ */ jsx(
                TextInput$1,
                {
                  placeholder,
            ...
            /* @__PURE__ */ jsxs(Flex, { tag: "span", gap: 3, children: [
              ...
              /* @__PURE__ */ jsx(DownIcon$1, { children: /* @__PURE__ */ jsx(CaretDown, {}) })
            ] })
          ] }),
...
const Header$1 = React.forwardRef(({ children, ...restProps }, forwardedRef) => {
  return /* @__PURE__ */ jsx(AlertDialog.Title, { asChild: true, children: /* @__PURE__ */ jsx(
    Title$1,
    {
      tag: "h2",
      ref: forwardedRef,
...
const ItemImpl = forwardRef(
  ({ col, s, xs, ...props }, forwardedRef) => /* @__PURE__ */ jsx(Item$1, { ref: forwardedRef, $col: col, $s: s, $xs: xs, ...props })
);
const Item$1 = styled(Box)`
  ...
  ({ variant: variant2 = "default", startIcon, endIcon, disabled = false, children, size = "S", ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      LinkWrapper$1,
      {
        ...
        ...props,
        children: [
          startIcon && /* @__PURE__ */ jsx(Flex, { "aria-hidden": true, children: startIcon }),
          /* @__PURE__ */ jsx(Typography, { variant: size === "S" ? "pi" : void 0, fontWeight: "bold", children }),
          endIcon && /* @__PURE__ */ jsx(Flex, { "aria-hidden": true, children: endIcon })
        ]
      }
...
const Content$2 = React.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsxs(Dialog$1.Portal, { children: [
    ...
    /* @__PURE__ */ jsx(ContentImpl, { ref: forwardedRef, ...props })
  ] });
});
...
const ScrollAreaImpl = ({ children, intersectionId, onReachEnd, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs(PopoverScrollArea, { ref: popoverRef, ...props, children: [
    children,
...
const RawTd = ({ coords = { col: 0, row: 0 }, tag = "td", ...props }) => {
  ...
  return /* @__PURE__ */ jsx(Box, { role: "gridcell", tag, ref: tdRef, onKeyDown: handleKeyDown, ...props });
};
    ...
    return /* @__PURE__ */ jsx(SearchbarWrapper, { children: /* @__PURE__ */ jsxs(Root$6, { name, children: [
      ...
      /* @__PURE__ */ jsx(
        SearchbarInput,
        {
          ...
          endAction: isCompleting ? /* @__PURE__ */ jsx(Action$1, { label: clearLabel, onClick: handleClear, children: /* @__PURE__ */ jsx(CloseIcon, {}) }) : void 0,
          ...props
        }
      )
    ] }) });
  ...
  ({
    ...
    const renderTags = (arg) => {
      if (arg && typeof arg === "object" && arg.value) {
        return /* @__PURE__ */ jsx(Tag, { tabIndex: -1, disabled, icon: /* @__PURE__ */ jsx(Cross, {}), onClick: handleTagClick(arg.value), children: arg.textValue }, arg.value);
      }
      return null;
    };
...
const Status = ({ variant: variant2 = "primary", showBullet = true, size = "M", children, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(
    Box,
    {
      ...
      paddingRight: paddingX,
      ...props,
      children: showBullet ? /* @__PURE__ */ jsxs(Flex, { gap: 3, children: [
        /* @__PURE__ */ jsx(Box, { background: bulletColor, width: "0.6rem", height: "0.6rem", borderRadius: "50%" }),
        children
      ] }) : children
    }
  );
...
const Table = ({ footer, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs(TableContainer, { shadow: "tableShadow", hasRadius: true, background: "neutral0", children: [
    /* @__PURE__ */ jsx(TableBox, { $overflowing: overflowing, position: "relative", children: /* @__PURE__ */ jsx(ScrollContainer, { ref: tableRef, onScroll: handleScroll, paddingLeft: 6, paddingRight: 6, children: /* @__PURE__ */ jsx(TableWrapper, { ...props }) }) }),
    footer
  ] });
};
...
const Th = ({ children, action, ...props }) => {
  return /* @__PURE__ */ jsx(CellWrapper, { as: RawTh, ...props, children: /* @__PURE__ */ jsxs(Flex, { children: [
    children,
    action
  ] }) });
};
const Td = ({ children, ...props }) => {
  return /* @__PURE__ */ jsx(CellWrapper, { ...props, children });
};
    ...
    return /* @__PURE__ */ jsxs(
      TextButtonWrapper,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: isDisabled ? "neutral600" : "primary600", children }),
          endIcon
        ]
      }
    );
